<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biz0103.aspx.cs" Inherits="join.pms.wap.SceneSvrs.Biz0103" %>
...
<title>农村部分计划生育家庭奖励扶助对象申报审核</title>
...
<body>
  ...
  <div class="flow_pic clearfix">
   ...
   <!--相关内容 -->
  <div class="part_05">
    <div class="part_name">计生家庭奖励扶助对象申报审核</div>

    <div class="part_form">
	  <div class="part_title"><span class="fr">∨</span>申请人基本信息</div>
	  <ul>
		<li>
		...
		<li>
		  ...
		  <p class="text"><asp:TextBox ID="txtPersonCidA" runat="server" EnableViewState="False" MaxLength="18" onblur="CheckCID0103('txtPersonCidA');" /></p>
		</li>
		<li>
    ...
    <input type="hidden" name="txtHNationsA" id="txtHNationsA" runat="server" style="display:none;"/></div>
		...
		<li>
		  ...
		  <p class="text"><asp:TextBox ID="txtAreaSelRegNameA" runat="server" EnableViewState="False" /></p>
    ...
    <div id="panelPeiou" style="display:none;" class="part_form">
	  <div class="part_title"><span class="fr">∨</span>配偶基本信息</div>
	 <ul>		
		<li>
		  <p class="title"><span class="xing">*</span>姓名</p>
    ...
    <div class="part_form">
	     ...
	     <ul>		
		    ...
		    <li>
		      ...
		      <p class="select"><asp:DropDownList ID="ddlFileds37" runat="server">                                       
                                            <asp:ListItem Value="0">0</asp:ListItem>
                                            <asp:ListItem Value="1">1</asp:ListItem>
                                            <asp:ListItem Value="2">2</asp:ListItem>
                                            <asp:ListItem Value="3">3</asp:ListItem>
                                            ...
                                            <asp:ListItem Value="5">5</asp:ListItem>
                                            <asp:ListItem Value="6">6</asp:ListItem>
                                        </asp:DropDownList>男&nbsp;&nbsp;<asp:DropDownList ID="ddlFileds38" runat="server">                                       
                                            <asp:ListItem Value="0">0</asp:ListItem>
                                            <asp:ListItem Value="1">1</asp:ListItem>
                                            <asp:ListItem Value="2">2</asp:ListItem>
                                            <asp:ListItem Value="3">3</asp:ListItem>
    ...
    <div class="part_form">
	 ...
	 <ul>		
		<li>
		  ...
		  <p class="text"><asp:TextBox ID="txtFileds18" runat="server" EnableViewState="False" MaxLength="100" Text="符合计划生育家庭奖励扶助政策"/></p>
		</li>
	  </ul>
	</div>
