...
{
    public partial class Biz0109 : UNV.Comm.Web.PageBase
    {
        #region
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(objID) && PageValidate.IsNumber(objID))
                {
                    ...
                    #endregion
                    //if (!String.IsNullOrEmpty(PersonPhotos[1])) { BIZ_Common.InsetBizDocs(objID, this.m_UserID, "本人近期一寸红底免冠正面照片", PersonPhotos, "0"); }
