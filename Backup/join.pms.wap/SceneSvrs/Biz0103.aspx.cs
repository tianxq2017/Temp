...
{
    public partial class Biz0103 : UNV.Comm.Web.PageBase
    {
        #region
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.m_PerA.MarryType != "未婚" && this.m_PerA.MarryType != "离婚" && this.m_PerA.MarryType != "丧偶")
            {
                ...
                if (String.IsNullOrEmpty(this.m_PerB.RegisterType)) { strErr += "请选择申请人户籍性质！\\n"; }
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(objID) && PageValidate.IsNumber(objID))
                {
                    ...
                    //if (!String.IsNullOrEmpty(PersonPhotos[1])) { BIZ_Common.InsetBizDocs(objID, this.m_UserID, "1寸红底免冠照片", PersonPhotos, "0"); }
