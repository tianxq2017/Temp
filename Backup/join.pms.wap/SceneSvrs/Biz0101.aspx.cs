...
{
    public partial class Biz0101 : UNV.Comm.Web.PageBase
    {
        #region
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(objID) && PageValidate.IsNumber(objID))
                {
                    ...
                    #endregion
                    if (this.m_BizStep != BIZ_Common.InsetBizWorkFlows(this.m_BizCode, this.m_BizStep, objID, perAAreaCode, perBAreaCode, this.m_AreaCode))
                    {
