...
write("<font style='color:"+gcFont+";cursor:hand; font- size:12px' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcFont'& gt;&nbsp;&nbsp;&nbsp;&nbsp;当前日期: "+giYear+"/"+giMonth+"/"+giDay+"</font>");
write("</td></tr></table>");
