...
namespace join.pms.web.SysAdmin
{
    public partial class StatsByUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.LiteralNav.Text = "统计分析 > 系统用户信息共享统计";
                SetUIParams("", "");
                GetDataList("", "");
            }
        }
        ...
        private void GetDataList(string startDate, string endDate)
        {
            ...
            sHtml.Append(statInfo + "，系统所有用户信息共享数量统计如下：<br/>");

            m_Dt = DbHelperSQL.Query(m_SqlParams).Tables[0];


            sHtml.Append("<table width=\"800\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\" bgcolor=\"#FFFFFF\"><tr>");
            sHtml.Append("<td width=\"40\" height=\"30\" align=\"center\" bgcolor=\"#99d0d0\" style=\"color:#FFFFFF;\"><strong>排名</strong></td>");
            sHtml.Append("<td width=\"180\" class=\"fb01\" bgcolor=\"#99d0d0\" align=\"center\" style=\"color:#FFFFFF;\">&nbsp;<strong>用户名称</strong></td>");
            sHtml.Append("<td class=\"fb01\" bgcolor=\"#99d0d0\" align=\"center\" style=\"color:#FFFFFF;\">&nbsp;<strong>信息共享数量</strong></td>");
            ...
            if (m_Dt.Rows.Count > 0)
            {
                ...
                sHtml.Append("<tr onmouseover=\"this.className='lvtColDataHover'\" onmouseout=\"this.className='lvtColData'\">");
                sHtml.Append("<td width=\"40\" height=\"20\" align=\"center\" bgcolor=\"#ffff99\" >合计</td>");
        ...
        protected void butExport_Click(object sender, EventArgs e)
        {
            try
            {
                string columnName = "排名,用户名称,信息共享数量";
                string strErr = string.Empty;
                string startDate = PageValidate.GetTrim(Request["txtStartTime"]);
                string endDate = PageValidate.GetTrim(Request["txtEndTime"]);
