...
namespace join.pms.web.SysAdmin
{
    public partial class StatsByLoginTime : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.LiteralNav.Text = "统计分析 > 用户使用情况按时间段统计 ";
                SetUIParams("", "");
                GetDataList("", "");
            }
        }
        ...
        private void GetDataList(string startDate, string endDate)
        {
            ...
            try
            {
                ...
                sHtml.Append(statInfo + "，用户系统登录使用情况统计如下：<br/>");
                ...
                sHtml.Append("<td width=\"200\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp;<strong>用户(登录名)</strong></td>");
                sHtml.Append("<td width=\"200\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>归属部门</strong></td>");
