...
namespace join.pms.web.BizInfo
{
    public partial class Biz0131 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.m_PerA.MarryType == "初婚" || this.m_PerA.MarryType == "再婚" || this.m_PerA.MarryType == "复婚")
            {
                /*配偶：姓名、性别、民族、户籍性质、身份证号、联系电话、婚姻状况、户籍地址、居住地址、出生年月*/
            ...
            if (String.IsNullOrEmpty(this.m_PerA.PersonTel)) { strErr += "请输入联系方式！\\n"; }
            ...
            try
            {
                ...
                //获取最新0150服务证号,如果没有服务证好，系统其他事项身份证号调用
                ...
                else
                {
                    ...
                    if (cm > 0)
                    {
                        ...
                        this.m_PerA.MateName = this.m_PerB.PersonName;
                        this.m_PerA.MateCardID = this.m_PerB.PersonCardID;
                        //string PersonIDA = this.m_PerA.ExecBizPersons();//不管男女单方发起业务不更新个人信息
                        //========配偶
                        this.m_PerB.MateName = this.m_PerA.PersonName;
                        this.m_PerB.MateCardID = this.m_PerA.PersonCardID;
                        //string PersonIDB = this.m_PerB.ExecBizPersons();//不管男女单方发起业务不更新个人信息
