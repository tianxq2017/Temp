<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editbiz0102.aspx.cs" Inherits="join.pms.web.BizInfo.EditBiz0102" %>
  ...
  <tr>
    ...
    <td class="text"><p><span><asp:TextBox ID="txtContactTelA" runat="server" EnableViewState="False" MaxLength="12"/></span></p></td>
        ...
        <div id="panelChildren" style="display:none;" class="form_a">
          <p class="form_title"><b>现有家庭子女信息</b></p>
          <div class="form_table">
          ...
          <div class="form_table">
            <table width="0" border="0" cellspacing="0" cellpadding="0">        
              <tr>
                ...
                <td>符合《内蒙古自治区人口与计划生育条例》规定，申请生育第<select id="ddlFileds18" name="ddlFileds18" runat="server">
