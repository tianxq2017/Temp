        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizCode))
                {
                    ...
                    s.Append("<div class=\"tr_03 clearfix\">");
                    s.Append("<div class=\"td_01\">符合《内蒙古自治区人口与计划生育条例》规定，申请生育第" + biz.Fileds18 + "孩。</div>");
                    ...
                    {
                        CommPage.SetBizLog(bizID, m_UserID, "业务打印", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 打印了" + biz.Fileds18 + "孩再生育登记表");
                        //保存打印的证件
                        join.pms.dal.BizWorkFlows log = new join.pms.dal.BizWorkFlows();
                        log.BizID = bizID;
                        log.BizCode = biz.BizCode;
                        log.SetCertificateLog(biz.BizName, biz.Fileds01, biz.PersonCidA, "打印了" + biz.Fileds18 + "孩再生育登记表");
                        log = null;
                    }
                }
                biz = null;
        ...
        private string GetWorkFlows(string bizID, string curAreaName, string attribs, ref string cerNo, string yjDate, string SelAreaCode, string StartDate)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count == 4)
                {
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[0]["Approval"].ToString() + "<br />" + OprateDate1 + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign1 + "<br />" + OprateDate1 + "</div>"); }
                    //
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[1]["Approval"].ToString() + "<br />" + OprateDate2 + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign2 + "<br />" + OprateDate2 + "</div>"); }
                    //
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[2]["Approval"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + dt.Rows[2]["AuditUser"].ToString() + "<br />" + OprateDate3 + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign3 + " <br /> 责任人：" + sign33 + " <br />" + OprateDate3 + "</div>"); }
                    //
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[3]["Approval"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + dt.Rows[3]["AuditUser"].ToString() + "<br />" + OprateDate4 + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign4 + " <br /> 责任人：" + sign44 + "<br />" + OprateDate4 + "</div>"); }
                    ...
                    {
                        b.Append("<div class=\"tr_06\"><div class=\"td_01\">生育期限：" + CertificateDateStart + "至" + CertificateDateEnd + "</div></div>");
                    }
                    else
                    {
                        if (string.IsNullOrEmpty(yjDate)) { b.Append("<div class=\"tr_06\"><div class=\"td_01\">xx</div></div>"); }
                        else { b.Append("<div class=\"tr_06\"><div class=\"td_01\">末次月经日期：" + yjDate + "</div></div>"); }
                        
                    }
                }
                else
                {
                    b.Append("<div class=\"tr_05 clearfix\"><br/>流程节点参数预制错误！<br/><br/></div>");
                }
                dt = null;
            }
            catch
