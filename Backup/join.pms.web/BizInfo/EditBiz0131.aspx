<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBiz0131.aspx.cs" Inherits="join.pms.web.BizInfo.EditBiz0131" %>
...
<body>
<object classid="clsid:F1317711-6BDE-4658-ABAA-39E31D3704D3" codebase="/Files/SDRdCard.cab#version=1,3,6,4" width="0" height="0" id="idcard" name="rdcard"></object>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <div id="divMarryChangDateA" style="display:block">
    <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <div id="divMarryChangDateB" style="display:block">
  <tr>
    <th><span class="xing">*</span>婚姻变动日期：</th>
                ...
                <td class="select"><asp:DropDownList ID="ddlChildSource4" runat="server">
                 ...
                 <td class="select"><asp:DropDownList ID="ddlMemos4" runat="server">
                       ...
                       <asp:ListItem>未征收未结案</asp:ListItem>
                             ...
                             <input type="hidden" name="txtChildID4" id="txtChildID4" value="" runat="server" style="display:none;"/> 
                ...
                <td class="select"><asp:DropDownList ID="ddlChildSource5" runat="server">
                 ...
                 <td class="select"><asp:DropDownList ID="ddlMemos5" runat="server">
                       ...
                       <asp:ListItem>未征收未结案</asp:ListItem>
                             ...
                             <input type="hidden" name="txtChildID5" id="txtChildID5" value="" runat="server" style="display:none;"/>                 
          </table>         
            </div>
        </div>
...
peiouforms();
function peiouforms(){
var optionss=$("#ddlMarryTypeA option:selected")
var objvalue=optionss.val(); // 选中值
//alert(objvalue);
 if(objvalue=="初婚"||objvalue=="再婚"){
 document.getElementById("panelPeiou").style.display="yes";
 }else{
