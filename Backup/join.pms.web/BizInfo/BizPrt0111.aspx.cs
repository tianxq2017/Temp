...
{
    public partial class BizPrt0111 : System.Web.UI.Page
    {
        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                {
                    qrInfo = "终止妊娠申请表；夫妇姓名、身份证号：" + biz.Fileds01 + "(" + biz.PersonCidA + ")、" + biz.Fileds08 + "(" + biz.PersonCidB + ")。";
                    workFlowInfo = GetWorkFlows(bizID, biz.CurAreaNameA, biz.Attribs, ref cerNo, biz.Fileds30, ref qrFiles, qrInfo);
                    //workFlowInfo = GetWorkFlows(bizID, biz.CurAreaNameA, biz.Attribs, ref cerNo, biz.Fileds30);
                    ...
                    s.Append("<div class=\"td_03\">" + CommBiz.GetAgeByID(biz.PersonCidB) + "岁</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_01 clearfix\">");
                    s.Append("<div class=\"td_01\">" + GetDateFormat(biz.Fileds42, "") + "</div>");
                    s.Append("<div class=\"td_02\">" + biz.Fileds43 + "周</div>");
                    s.Append("<div class=\"td_03\">" + biz.Fileds30 + "</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_01 clearfix\">");
                    s.Append("<div class=\"td_04\">" + biz.PersonCidB + "</div>");
                    s.Append("<div class=\"td_03\">" + biz.Fileds13 + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"td_01\">" + GetDateFormat(children.ChildBirthday1, "") + "</div>");
                    s.Append("<div class=\"td_01\">1孩</div>");
                    s.Append("<div class=\"td_01\">" + children.ChildPolicy1 + "</div>");
                    s.Append("<div class=\"td_03\">" + children.Memos1 + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"td_01\">" + GetDateFormat(children.ChildBirthday2, "") + "</div>");
                    ...
                    {
                        s.Append("<div class=\"td_01\">2孩</div>");
                    }
                    s.Append("<div class=\"td_01\">" + children.ChildPolicy2 + "</div>");
                    s.Append("<div class=\"td_03\">" + children.Memos2 + "</div>");
                    s.Append("</div>");
                    ...
                    {
                        CommPage.SetBizLog(bizID, m_UserID, "业务打印", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 打印了终止妊娠申请表");
                        //保存打印的证件
                        join.pms.dal.BizWorkFlows log = new join.pms.dal.BizWorkFlows();
                        log.BizID = bizID;
                        log.BizCode = biz.BizCode;
                        log.SetCertificateLog(biz.BizName, biz.Fileds01, biz.PersonCidA, "打印了终止妊娠申请表");
                        log = null;
                    }
                }
                biz = null;
        ...
        /// <returns></returns>
        private string GetWorkFlows(string bizID, string curAreaName, string attribs, ref string cerNo, string bitPolicy, ref string qrFiles, string qrInfo)
        {
            string seal1 = "", seal2 = "", seal3 = "", seal4 = "", seal5 = "", seal6 = string.Empty;
            string sign1 = "", sign2 = "", sign3 = "", sign33 = "", sign4 = "", sign5 = "", sign6 = "", sign66 = string.Empty;
            string validDateEnd = string.Empty;
            StringBuilder b = new StringBuilder();
            DataTable dt = new DataTable();
            try
            {
                m_SqlParams = "SELECT AreaName,Comments,Approval,AuditUser,ApprovalUserTel,Signature,OprateDate,CertificateNoA,CertificateNoB,CertificateMemo,BizStepTotal,ApprovalSignPath,AuditUserSignPath FROM BIZ_WorkFlows WHERE BizID=" + bizID + " ORDER BY BizStep";
                ...
                if (bitPolicy == "政策内")
                {
                    if (dt.Rows.Count == 6)
                    {
                        ...
                        seal5 = dt.Rows[4]["Signature"].ToString();
                        seal6 = dt.Rows[5]["Signature"].ToString();
                        ...
                        if (!string.IsNullOrEmpty(seal5)) seal5 = "<img src=\"" + seal5 + "\"   height=\"165\"/>";
                        if (!string.IsNullOrEmpty(seal6)) seal6 = "<img src=\"" + seal6 + "\"   height=\"165\"/>";
                        ...
                        sign5 = dt.Rows[4]["ApprovalSignPath"].ToString();
                        sign6 = dt.Rows[5]["ApprovalSignPath"].ToString();
                        sign66 = dt.Rows[5]["AuditUserSignPath"].ToString();
                        ...
                        if (!string.IsNullOrEmpty(sign5)) sign5 = "<img src=\"" + sign5 + "\"  height=\"25\" />";
                        if (!string.IsNullOrEmpty(sign6)) sign6 = "<img src=\"" + sign6 + "\"  height=\"25\" />";
                        if (!string.IsNullOrEmpty(sign66)) sign66 = "<img src=\"" + sign66 + "\"  height=\"25\" />";

                        if (dt.Rows[0]["BizStepTotal"].ToString() == "6") { cerNo = dt.Rows[5]["CertificateNoA"].ToString(); }
                        else { cerNo = dt.Rows[2]["CertificateNoA"].ToString(); }

                        //村
                        b.Append("<div class=\"tr_05 clearfix\">");
                        b.Append("<div class=\"tr_l\">");
                        b.Append("<div class=\"td_01\">" + dt.Rows[0]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[0]["Approval"].ToString() + "<br />" + GetDateFormat(dt.Rows[0]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign1 + "<br />" + GetDateFormat(dt.Rows[0]["OprateDate"].ToString(), "1") + "</div>");
                        ...
                        b.Append("<div class=\"td_02\">经办人：" + sign2 + "<br />" + GetDateFormat(dt.Rows[1]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"official\">" + seal2 + "</div>");
                        b.Append("</div>");
                        b.Append("</div>");

                        //医疗部门
                        b.Append("<div class=\"tr_04 clearfix\">");
                        b.Append("<div class=\"tr_l\">");
                        b.Append("<div class=\"td_01\">" + dt.Rows[2]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[2]["Approval"].ToString() + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign3 + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("</div>");
                        b.Append(" <div class=\"tr_c\">");
                        b.Append("<div class=\"td_01\">" + dt.Rows[3]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[3]["Approval"].ToString() + "<br />" + GetDateFormat(dt.Rows[3]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign4 + "<br />" + GetDateFormat(dt.Rows[3]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("</div>");
                        b.Append(" <div class=\"tr_r\">");
                        b.Append("<div class=\"td_01\">" + dt.Rows[4]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[4]["Approval"].ToString() + "<br />" + GetDateFormat(dt.Rows[4]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign5 + "<br />" + GetDateFormat(dt.Rows[4]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("</div>");
                        b.Append("</div>");
                        ...
                        b.Append("<div class=\"td_01\">" + dt.Rows[5]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[5]["Approval"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + dt.Rows[5]["AuditUser"].ToString() + "<br />" + GetDateFormat(dt.Rows[5]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign6 + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + sign66 + "<br />" + GetDateFormat(dt.Rows[5]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append(" <div class=\"official\">" + seal6 + "</div>");
                        b.Append("</div>");
                        //}
                        //else
                        //{
                        ...
                        //    b.Append("<div class=\"td_02\">经办人：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;责任人：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></div>");
                ...
                else
                {
                    if (dt.Rows.Count == 3)
                    {
                        ...
                        b.Append("<div class=\"tr_06\">");
                        b.Append("<div class=\"td_01\">" + dt.Rows[2]["Comments"].ToString() + "</div>");
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[2]["Approval"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + dt.Rows[2]["AuditUser"].ToString() + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign3 + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + sign33 + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
