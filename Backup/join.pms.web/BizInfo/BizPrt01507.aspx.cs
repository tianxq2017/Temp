...
{
    public partial class BizPrt01507 : System.Web.UI.Page
    {
        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            SqlDataReader sdr = null;
                ...
                {
                    CommPage.SetBizLog(bizID, m_UserID, "业务打印", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 打印了01507");
                    //保存打印的证件
                    join.pms.dal.BizWorkFlows log = new join.pms.dal.BizWorkFlows();
                    log.BizID = bizID;
                    log.BizCode = "0150";
                    log.SetCertificateLog("01507", helpbiz_Fileds01, PersonCids, "打印了01507");
                    log = null;
                }
