<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BizPrt01507.aspx.cs" Inherits="join.pms.web.BizInfo.BizPrt01507" %>
<%@ Register Src="../userctrl/BizPrt0150Menu.ascx" TagName="BizPrt0150Menu" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>接种记录3\4《婚育健康服务证》</title>
...
<div class="print" style="width:549px;">
  ...
  <p><img src="/BizInfo/images/info/07.gif" /></p>
</div>
</form>
</body>
</html>