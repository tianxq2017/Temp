...
{
    public partial class BizPrt0103 : System.Web.UI.Page
    {
        ...
        private void DelBiz(string bizID)
        {
            try
            {
                ...
                if (CommPage.CheckBizDelAttribs("BizID IN(" + bizID + ")"))
                {
                    ...
                    CommPage.SetBizLog(bizID, m_UserID, "业务撤销", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 进行了业务(农村部分计划生育家庭奖励扶助对象申报审核)撤销操作");
        ...
        private void SetBizLogOff(string bizID)
        {
            try
            {
                if (CommPage.CheckLogOffAttribs("BizID IN(" + bizID + ")"))
                {
                    ...
                    CommPage.SetBizLog(bizID, m_UserID, "业务注销", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 进行了业务(农村部分计划生育家庭奖励扶助对象申报审核)注销操作");
        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizCode))
                {
                    ...
                    s.Append("<div class=\"td_07\">" + GetDateFormat(biz.Fileds34, "") + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"td_07\">" + GetDateFormat(biz.Fileds14, "") + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"tr_03 clearfix\" style=\"padding-top:35px;\">");
                    ...
                    s.Append("<div class=\"td_01\" style=\"margin-top:-5px;\">" + biz.RegAreaNameA + "</div>");
