...
{
    public partial class EditBiz0131 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            try
            {
                ...
                else
                {
                    ...
                    this.txtFileds34.Value = this.m_BizC.Fileds34;
                   ...
                   //}
                    ...
                    //婚前检查
                    this.txtFileds22.Value = this.m_BizC.Fileds22;
                    this.txtFileds23.Text = this.m_BizC.Fileds23;
                    this.txtFileds24.SelectedValue = this.m_BizC.Fileds24;
                    this.txtFileds25.Text = this.m_BizC.Fileds25;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.m_PerA.MarryType == "初婚" || this.m_PerA.MarryType == "再婚")
            {
                ...
                if (String.IsNullOrEmpty(Fileds34)) strErr += "请选择持证人婚姻变动日期！\\n";
            ...
            if (String.IsNullOrEmpty(this.m_PerA.PersonTel)) { strErr += "请输入联系电话！\\n"; }
            ...
            if (iBirthNum == 0)
            {
                ...
                CommID1 = ""; ChildName1 = ""; ChildSex1 = ""; ChildBirthday1 = ""; ChildPolicy1 = ""; ChildCardID1 = ""; ChildSource1 = ""; ChildMemos1 = "";
                CommID2 = ""; ChildName2 = ""; ChildSex2 = ""; ChildBirthday2 = ""; ChildPolicy2 = ""; ChildCardID2 = ""; ChildSource2 = ""; ChildMemos2 = "";
                CommID3 = ""; ChildName3 = ""; ChildSex3 = ""; ChildBirthday3 = ""; ChildPolicy3 = ""; ChildCardID3 = ""; ChildSource3 = ""; ChildMemos3 = "";
                CommID4 = ""; ChildName4 = ""; ChildSex4 = ""; ChildBirthday4 = ""; ChildPolicy4 = ""; ChildCardID4 = ""; ChildSource4 = ""; ChildMemos4 = "";
                CommID5 = ""; ChildName5 = ""; ChildSex5 = ""; ChildBirthday5 = ""; ChildPolicy5 = ""; ChildCardID5 = ""; ChildSource5 = ""; ChildMemos5 = "";
            }
            else if (iBirthNum == 1)
            {
                CommID2 = ""; ChildName2 = ""; ChildSex2 = ""; ChildBirthday2 = ""; ChildPolicy2 = ""; ChildCardID2 = ""; ChildSource2 = ""; ChildMemos2 = "";
            ...
            try
            {
                ...
                this.m_BizC.QcfwzBm = CommPage.GetSingleVal(" select top 1  QcfwzBm from BIZ_Contents  WHERE BizCode='0150' and QcfwzBm!='' and  Attribs IN(2,8,9) " + QcfwzBm_where + " order by BizID desc ");
