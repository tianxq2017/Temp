<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BizPrt01505.aspx.cs" Inherits="join.pms.web.BizInfo.BizPrt01505" %>
<%@ Register Src="../userctrl/BizPrt0150Menu.ascx" TagName="BizPrt0150Menu" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>儿童保健服务、儿童预防接种基础信息《婚育健康服务证》</title>
...
<div class="print">
  ...
  <p><img src="/BizInfo/images/info/05.gif" /></p>
</div>
</form>
</body>
</html>