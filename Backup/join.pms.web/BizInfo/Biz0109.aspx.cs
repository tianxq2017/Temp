...
{
    public partial class Biz0109 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //this.m_BizC.PersonPhotos = PersonPhotos[1];//本人近期一寸红底免冠正面照片
                ...
                if (!string.IsNullOrEmpty(objID) && PageValidate.IsNumber(objID))
                {
                    ...
                    #endregion
                    if (this.m_BizStep != BIZ_Common.InsetBizWorkFlows(this.m_FuncCode, this.m_BizStep, objID, perAAreaCode, perBAreaCode, m_AreaCode))
                    {
                    ...
                    #endregion
                    //if (!String.IsNullOrEmpty(PersonPhotos[1])) { BIZ_Common.InsetBizDocs(objID, PersonIDA, "本人近期一寸红底免冠正面照片", PersonPhotos, "1"); }
