...
{
    public partial class BizPrt0105 : System.Web.UI.Page
    {
        ...
        private void DelBiz(string bizID)
        {
            try
            {
                ...
                if (CommPage.CheckBizDelAttribs("BizID IN(" + bizID + ")"))
                {
                    ...
                    CommPage.SetBizLog(bizID, m_UserID, "业务撤销", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 进行了业务(计划生育“少生快富”工程申请审核表)撤销操作");
        ...
        private void SetBizLogOff(string bizID)
        {
            try
            {
                if (CommPage.CheckLogOffAttribs("BizID IN(" + bizID + ")"))
                {
                    ...
                    CommPage.SetBizLog(bizID, m_UserID, "业务注销", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 进行了业务(计划生育“少生快富”工程申请审核表)注销操作");
        ...
        {
            string cerNo = "",photos="", workFlowInfo = string.Empty;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizCode))
                {
                    ...
                    qrInfo = "计划生育“少生快富”工程申请审核表；夫妇姓名、身份证号：" + biz.Fileds01 + "(" + biz.PersonCidA + ")、" + biz.Fileds08 + "(" + biz.PersonCidB + ")。";
                    ...
                    s.Append("<div class=\"td_07\">" + biz.Fileds14 + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"td_07\">" + biz.Fileds34 + "</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_02 clearfix\">");
                    s.Append("<div class=\"td_01\">" + biz.Fileds40 + "个孩子</div>");
                    s.Append("<div class=\"td_02\">" + biz.Fileds37 + "男 " + biz.Fileds38 + "女</div>");
                    s.Append("</div>");

                    //子女信息
                    BIZ_PersonChildren children = new BIZ_PersonChildren();
                    children.Select(" BizID=" + bizID);

                    s.Append("<div class=\"tr_03 clearfix\" style=\"padding-top:43px;\">");
                    ...
                    s.Append("<div class=\"td_04\">" + children.ChildSurvivalStatus1 + "</div>");
                    ...
                    s.Append("<div class=\"td_04\">" + children.ChildSurvivalStatus2 + "</div>");
                    ...
                    s.Append("<div class=\"td_04\">" + children.ChildSurvivalStatus3 + "</div>");
                    ...
                    s.Append("<div class=\"td_04\">" + children.ChildSurvivalStatus4+ "</div>");
                    ...
                    s.Append("<div class=\"td_02\">" + biz.Fileds46 + "</div>");
                    s.Append("<div class=\"td_03\">" + GetDateFormat(biz.Fileds44, "") + "</div>");
                    s.Append("</div>");


                    s.Append("<div class=\"tr_05 clearfix\">");
                    s.Append("<div class=\"td_01\">" + biz.RegAreaNameB + "</div>");
