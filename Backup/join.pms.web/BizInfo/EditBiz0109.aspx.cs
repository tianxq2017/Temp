...
{
    public partial class EditBiz0109 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            try
            {
                ...
                else
                {
                    ...
                    /*持证人：姓名、性别、婚姻状况、婚姻变动日期、出生年月、身份证号、联系电话、户籍性质、户籍地址、居住地址*/
                    ...
                    {
                        /*配偶：姓名、性别、婚姻状况、婚姻变动日期、出生年月、身份证号、联系电话、户籍性质、户籍地址、居住地址*/
                    ...
                    //避孕措施
                    this.ddlFileds45.Text = this.m_BizC.Fileds45;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.m_PerA.MarryType == "初婚" || this.m_PerA.MarryType == "再婚")
            {
                ...
                Fileds14 = CommBiz.GetTrim(this.txtFileds14.Value);
            ...
            if (String.IsNullOrEmpty(Fileds34)) { strErr += "请选择婚姻变动日期！\\n"; }
            ...
            if (this.m_PerA.MarryType == "初婚" || this.m_PerA.MarryType == "再婚")
            {
                ...
                if (String.IsNullOrEmpty(Fileds14)) { strErr += "请选择婚姻变动日期！\\n"; }
            ...
            {
                ChildName2 = ""; ChildSex2 = ""; ChildBirthday2 = ""; ChildCardID2 = ""; ChildPolicy2 = ""; ChildSource2 = ""; ChildMemos2 = "";
                ChildName3 = ""; ChildSex3 = ""; ChildBirthday3 = ""; ChildCardID3 = ""; ChildPolicy3 = ""; ChildSource3 = ""; ChildMemos3 = "";
            ...
            #endregion
            /*避孕措施 */
            string Fileds45 = PageValidate.GetTrim(this.ddlFileds45.Text);
            if (String.IsNullOrEmpty(Fileds45)) { strErr += "请输入避孕措施！\\n"; }
            ...
            try
            {
                ...
                if (cm > 0)
                {
                    ...
                    //{
                    //    if (!String.IsNullOrEmpty(this.txtIsHasPhotos.Value)) { BIZ_Common.UpdateBizDocs(objID, PersonIDA, "", "本人近期一寸红底免冠正面照片", PersonPhotos); }
                    //    else { BIZ_Common.InsetBizDocs(objID, PersonIDA,  "本人近期一寸红底免冠正面照片", PersonPhotos,"1"); }
                    //}
