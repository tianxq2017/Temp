<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BizPrt0131.aspx.cs" Inherits="join.pms.web.BizInfo.BizPrt0131" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>婚前医学检查证明申请表</title>
...
<div class="print_0131">
  <div class="title">婚前医学检查证明</div>
  <asp:Literal ID="LiteralBizInfo" runat="server" EnableViewState="false" />
  <p><img src="/BizInfo/images/info/0131.gif" /></p>
