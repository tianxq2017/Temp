        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizCode))
                {
                    ...
                    s.Append("<div class=\"number\">婚育证明编号：" + cerNo + "</div>");
                    ...
                    {
                        CommPage.SetBizLog(bizID, m_UserID, "业务打印", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 打印了流动人口婚育证明申请表");
                        //保存打印的证件
                        join.pms.dal.BizWorkFlows log = new join.pms.dal.BizWorkFlows();
                        log.BizID = bizID;
                        log.BizCode = biz.BizCode;
                        log.SetCertificateLog(biz.BizName, biz.Fileds01, biz.PersonCidA, "打印了流动人口婚育证明申请表");
                        log = null;
                    }
                }
                biz = null;
            ...
            try
            {
                ...
                if (marry == "初婚" || marry == "再婚")
                {
                    if (dt.Rows.Count == 3)
                    {
                        ...
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[0]["Approval"].ToString() + "<br />联系电话：" + dt.Rows[0]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[0]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign1 + "<br />联系电话：" + dt.Rows[0]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[0]["OprateDate"].ToString(), "1") + "</div>");
                        ...
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[1]["Approval"].ToString() + "<br />联系电话：" + dt.Rows[1]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[1]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign2 + "<br />联系电话：" + dt.Rows[1]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[1]["OprateDate"].ToString(), "1") + "</div>");
                        ...
                        //b.Append("<div class=\"td_02\">经办人：" + dt.Rows[2]["Approval"].ToString() + "<br />联系电话：" + dt.Rows[2]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
                        b.Append("<div class=\"td_02\">经办人：" + sign3 + "<br />联系电话：" + dt.Rows[2]["ApprovalUserTel"].ToString() + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>");
                        ...
                        //    b.Append("<div class=\"td_02\">经办人：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>");
