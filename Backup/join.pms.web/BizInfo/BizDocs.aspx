<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BizDocs.aspx.cs" Inherits="join.pms.web.BizInfo.BizDocs" %>
...
<asp:Button ID="btnAdd" runat="server" Text="· 提交 ·"   OnClientClick="return check();" OnClick="btnAdd_Click" CssClass="submit6"></asp:Button>
