...
{
    public partial class BizPrt0108 : System.Web.UI.Page
    {
        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizCode))
                {
                    ...
                    //母亲信息
                    s.Append("<div class=\"tr_01 clearfix\" style=\"padding-top:11px;\">");
                    ...
                    string strUnitB = string.Empty ;
                    if (string.IsNullOrEmpty(biz.Fileds12))
                    {
                        strUnitB = biz.CurAreaNameB;
                    }
                    else
                    {
                        strUnitB = biz.Fileds12;
                    }
                    s.Append("<div class=\"td_03\">" + strUnitB + "</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_01 clearfix\">");
                    s.Append("<div class=\"td_01\">" + biz.Fileds11 + "</div>");
                    s.Append("<div class=\"td_03\">" + biz.RegAreaNameB + "</div>");
                    s.Append("</div>");
                    //父亲信息
                    s.Append("<div class=\"tr_01 clearfix\">");
                    ...
                    string strUnitA = string.Empty;
                    if (string.IsNullOrEmpty(biz.Fileds05))
                    {
                        strUnitA = biz.CurAreaNameA;
                    }
                    else
                    {
                        strUnitA = biz.Fileds05;
                    }
                    s.Append("<div class=\"td_03\">" + strUnitA + "</div>");
                    s.Append("</div>");
                    ...
                    s.Append("<div class=\"td_01\">" + biz.Fileds16 + "</div>");
                    s.Append("<div class=\"td_02\">" + biz.Fileds17 + "</div>");
                    s.Append("<div class=\"td_03\">" + biz.Fileds40 + "</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_03 clearfix\">");
                    s.Append("<div class=\"td_01\">" + biz.Fileds44 + "</div>");
                    s.Append("<div class=\"td_03\">" + GetDateFormat(biz.Fileds20, "") + "</div>");
                    s.Append("</div>");

                    s.Append("<div class=\"tr_05 clearfix\">");
                    s.Append("<div class=\"td_01 td_left\">" + biz.ContactTelB + "&nbsp;&nbsp;" + biz.ContactTelA + "</div>");
                    s.Append("</div>");
                    ...
                    //编号
                    s.Append("<div class=\"tr_05 clearfix\" style=\"height:30px;\">");
                    s.Append("<div class=\"td_01\">" + cerNo + "</div>");
                    if (m_ActionName == "priint")
                    {
                        s.Append("<div class=\"td_02\">" + GetDateFormat(DateTime.Now.ToString(), "1") + " </div>");
                    }
                    else
                    {
                    ...
                    s.Append("<div class=\"td_02\">申请人（签名）：<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;月&nbsp;&nbsp;日</div>");
                    s.Append("</div>");
                    ...
                    if (m_ActionName == "priint")
                    {
                        CommPage.SetBizLog(bizID, m_UserID, "业务打印", "用户ID[" + m_UserID + "-]于 " + DateTime.Now.ToString() + " 打印了独生子女父母光荣证申请审核表");
                        //保存打印的证件
                        join.pms.dal.BizWorkFlows log = new join.pms.dal.BizWorkFlows();
                        log.BizID = bizID;
                        log.BizCode = biz.BizCode;
                        log.SetCertificateLog(biz.BizName, biz.Fileds01, biz.PersonCidA, "打印了独生子女父母光荣证申请审核表");
                        log = null;
                    }
                }
                biz = null;
        ...
        private string GetWorkFlows(string bizID, string curAreaName, string attribs, ref string cerNo, string SelAreaCode, string StartDate)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count == 3)
                {
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[1]["Approval"].ToString() + "<br />" + GetDateFormat(dt.Rows[1]["OprateDate"].ToString(), "1") + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign2 + "<br />" + GetDateFormat(dt.Rows[1]["OprateDate"].ToString(), "1") + "</div>"); }
                    ...
                    //兼容库伦系统
                    if (int.Parse(bizID) < 3099 && SelAreaCode.Substring(0, 6) == "150524") { b.Append("<div class=\"td_02\">经办人：" + dt.Rows[2]["Approval"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + dt.Rows[2]["AuditUser"].ToString() + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>"); }
                    else { b.Append("<div class=\"td_02\">经办人：" + sign3 + "&nbsp;&nbsp;&nbsp;&nbsp;责任人：" + sign33 + "<br />" + GetDateFormat(dt.Rows[2]["OprateDate"].ToString(), "1") + "</div>"); }
