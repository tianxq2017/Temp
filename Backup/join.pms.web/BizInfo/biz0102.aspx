<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="biz0102.aspx.cs" Inherits="join.pms.web.BizInfo.biz0102" %>
...
<div class="form_bg">
  ...
  <tr>
    ...
    <td class="text"><p><span><asp:TextBox ID="txtfwzh" runat="server" EnableViewState="False" MaxLength="20"  onblur="GetFwzInfo(document.getElementById('txtfwzh').value,'0102B','0102A','1');" /></span></p>
    <input type="button" name="button" value="自动获取资料" class="button"  onclick="GetFwzInfo(document.getElementById('txtfwzh').value,'0102B','0102A','1');"/>
    </td>
  </tr>
  </table>
          </div>
...
<div class="form_table" style=" display:none">
<table width="0" border="0" cellspacing="0" cellpadding="0">
  <tr>
     ...
     <td class="select"><asp:DropDownList ID="ddlBirthNum" runat="server" onchange="ShowBirth0101();">
        ...
        <div id="panelChildren" style="display:none;" class="form_a">
          ...
          <table width="0" border="0" cellspacing="0" cellpadding="0" class="tdcolumns">	        
            <tr><th><span class="xing">*</span>子女姓名</th><th><span class="xing">*</span>出生日期</th><th><span class="xing">*</span>性别</th><th>身份证号或出生医学<br/>证明或收养证号</th><th><span class="xing">*</span>父亲姓名</th><th><span class="xing">*</span>母亲姓名</th><th>政策属性</th><th>其他情况</th></tr>
            <tr id="tableChild1">
          ...
          <div class="form_table">
            <table width="0" border="0" cellspacing="0" cellpadding="0">        
              <tr>
                ...
                <td class="">符合《内蒙古自治区人口与计划生育条例》规定，申请生育第二孩。<div style=" display:none"><select id="ddlFileds18" name="ddlFileds18" runat="server">
