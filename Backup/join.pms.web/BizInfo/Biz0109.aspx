<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biz0109.aspx.cs" Inherits="join.pms.web.BizInfo.Biz0109" %>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidA').value,'0109A','1');"/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidB').value,'0109B','1');"/>
    </td>
  </tr>
    <tr>
    <th><span class="xing">*</span>户籍地址：</th>
