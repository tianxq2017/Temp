...
{
    public partial class BizCer0102 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(biz.BizID))
                {
                    ...
                    if (!string.IsNullOrEmpty(workFlowsID) && string.IsNullOrEmpty(QRCodeFiles))
                    {
                        ...
                        string qrInfo = "二孩生育登记；夫妻姓名及身份证号：" + biz.Fileds01 + "(" + biz.PersonCidA + ")、" + biz.Fileds08 + "(" + biz.PersonCidB + ")；登记日期：" + optateDate;
  ...
  <p><img src="images/info/paper_0102b.gif" /></p>
                     */
                    s.Append("<div class=\"paper_print_0102b\">");
                    ...
                    s.Append("</div>");
                    s.Append("</div>");
                    s.Append("<p><img src=\"/BizInfo/images/info/paper_0102b.gif\" /></p>");
                    ...
                    s.Append("<div class=\"tr_02 clearfix\" style=\"padding-top:33px;\">");
                    ...
                    s.Append("</div>");
                    s.Append("</div>");
                    s.Append("<p><img src=\"/BizInfo/images/info/paper_0102b_2.gif\" /></p>");
                    s.Append("</div>");
                    //服务证副页
                    ...
                    s.Append("</div>");
                    s.Append("<p><img src=\"/BizInfo/images/info/paper_0102c.gif\" /></p>");
