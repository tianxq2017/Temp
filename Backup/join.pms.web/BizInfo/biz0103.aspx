<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="biz0103.aspx.cs" Inherits="join.pms.web.BizInfo.biz0103" %>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="text"><p><span><asp:TextBox ID="txtPersonCidA" runat="server" EnableViewState="False" MaxLength="18"  onblur="CheckCID0103('txtPersonCidA');"/></span></p>
    <input type="button" name="btnCardA" value="刷身份证" class="button button2" onclick="ReadCardA_onclick();"/>
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidA').value,'0103A','1');"/>
    </td>
  </tr> 
  <tr>
    <th>外籍身份证号：</th>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidB').value,'0103B','1');"/>
    </td>
  </tr>
  <tr>
    <th>外籍身份证号：</th>
