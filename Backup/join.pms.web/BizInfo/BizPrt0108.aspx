<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BizPrt0108.aspx.cs" Inherits="join.pms.web.BizInfo.BizPrt0108" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>独生子女父母光荣证申请审核表</title>
...
<div class="print_0108">
  <div class="title">独生子女父母光荣证申请表</div>
  <asp:Literal ID="LiteralBizInfo" runat="server" EnableViewState="false" />
  <p><img src="/BizInfo/images/info/0108.gif" /></p>
