<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBiz0110.aspx.cs" Inherits="join.pms.web.BizInfo.EditBiz0110" %>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <th>电子邮件：</th>
    <td class="text"><p><span><asp:TextBox ID="txtMail" runat="server" EnableViewState="False" /> </span></p></td>
  </tr>
   <tr>
    ...
    <th><span class="xing">*</span>已生育子女数：</th>
     <td class="select"><asp:DropDownList ID="ddlBirthNum" runat="server" onchange="ShowBirth0101();">
                   ...
                   </asp:DropDownList>(<span style="color:#ff0000">超过三个咨询办理</span>)</td>
  </tr>  
