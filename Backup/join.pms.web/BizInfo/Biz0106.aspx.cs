...
{
    public partial class Biz0106 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            /*申请人：身份证号、姓名、性别、出生年月、婚姻状况、婚姻时间、联系电话、户籍性质、户籍地址、现居住地、子女数*/
            ...
            /*配偶：身份证号、姓名、性别、出生年月、婚姻状况、婚姻时间、联系电话、户籍性质、户籍地址、现居住地、子女数*/
            ...
            {
                if (CommBiz.GetAgeByID(this.m_PerA.PersonCardID) > 49) { strErr += "女方必须在49周岁内才可以申请！"; }
            }
            ...
            if (String.IsNullOrEmpty(Fileds27)) { strErr += "请输入手术医院！\\n"; }
            if (String.IsNullOrEmpty(Fileds28)) { strErr += "请选择手术日期！\\n"; }
            ...
            try
            {
                ...
                this.m_BizC.Fileds07 = this.m_PerA.BirthNum;//子女数

                /*配偶：身份证号、姓名、性别、出生年月、婚姻状况、婚姻时间、联系电话、户籍性质、户籍地址、现居住地*/
                ...
                if (!string.IsNullOrEmpty(objID) && PageValidate.IsNumber(objID))
                {
                    ...
                    #endregion
                    if (this.m_BizStep != BIZ_Common.InsetBizWorkFlows(this.m_FuncCode, this.m_BizStep, objID, perAAreaCode, perBAreaCode, ""))
                    {
