<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBiz0122.aspx.cs" Inherits="join.pms.web.BizInfo.EditBiz0122" %>
...
<tr id="tableChild6"style="display:none;" >
            ...
            <input type="hidden" name="txtChildID6" id="txtChildID6" value="" runat="server" style="display:none;"/>          
          </table>         
            </div>
        </div>
