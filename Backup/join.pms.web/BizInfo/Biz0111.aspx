<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biz0111.aspx.cs" Inherits="join.pms.web.BizInfo.Biz0111" %>
...
<!-- 编辑区  -->
  ...
  <tr>
    ...
    <td class="select"><asp:DropDownList ID="ddlPolicyB" runat="server" onchange="ShowFiled18();">
                        ...
                        </asp:DropDownList><b class="ps">选择后不能修改</b></td>
  </tr>
   <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidB').value,'0111B','1');"/>
    </td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <th><span class="xing">*</span>已生育子女数：</th>
     <td class="select"><asp:DropDownList ID="ddlBirthNum" runat="server" onchange="ShowBirth0111();">
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidA').value,'0111A','1');"/>
    </td>
  </tr>
   <tr>
        <th><span class="xing">*</span>户籍地址：</th>
