<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biz0105.aspx.cs" Inherits="join.pms.web.BizInfo.Biz0105" %>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidB').value,'0105B','1');"/>
    </td>
  </tr>
  <tr>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <input type="button" name="button" value="自动获取资料" class="button" onclick="GetPersonsInfo(document.getElementById('txtPersonCidA').value,'0105A','1');"/>
    </td>
  </tr> 
  <tr>
    <th><span class="xing">*</span>婚姻状况：</th>
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <tr>
    <th><span class="xing">*</span>现有子女数（含收养）：</th>
