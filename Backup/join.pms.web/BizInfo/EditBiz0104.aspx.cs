...
{
    public partial class EditBiz0104 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            try
            {
                ...
                else
                {
                    ...
                    /*申请人：身份证号、姓名、婚姻状况、婚姻时间、联系电话、户籍性质、户籍地址*/
                    ...
                    /*配偶：身份证号、姓名、婚姻状况、婚姻时间、联系电话、户籍性质*/
                    ...
                    this.ddlFileds22.SelectedValue = this.m_BizC.Fileds22;

                    /*伤残信息*/
                    this.txtFileds23.Text = this.m_BizC.Fileds23;
                    this.ddlFileds24.SelectedValue = this.m_BizC.Fileds24;
                    this.ddlFileds26.SelectedValue = this.m_BizC.Fileds26;
