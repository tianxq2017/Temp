...
{
    public partial class EditBiz0103 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            try
            {
                ...
                else
                {
                    ...
                    /*申请人：身份证号、姓名、婚姻状况、婚姻时间、民族、联系电话、户籍性质、户籍地址*/
                    ...
                    /*配偶：身份证号、姓名、婚姻状况、婚姻时间、民族、联系电话、户籍性质*/
                    ...
                    /*子女数*/
                    this.ddlFileds20.SelectedValue = this.m_BizC.Fileds20;
                    this.ddlFileds21.SelectedValue = this.m_BizC.Fileds21;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            this.m_Children.CommID4 = this.txtChildID4.Value;
            ...
            this.m_Children.CommID5 = this.txtChildID5.Value;
            ...
            this.m_Children.CommID6 = this.txtChildID6.Value;
            ...
            try
            {
                ...
                if (cm > 0)
                {
                    ...
                    //{
                    //    if (!String.IsNullOrEmpty(this.txtIsHasPhotos.Value)) { BIZ_Common.UpdateBizDocs(objID, PersonIDA, "", "1寸红底免冠照片", PersonPhotos); }
                    //    else { BIZ_Common.InsetBizDocs(objID, PersonIDA, "1寸红底免冠照片", PersonPhotos, "1"); }
                    //}
