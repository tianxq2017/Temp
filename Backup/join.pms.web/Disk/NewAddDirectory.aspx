<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewAddDirectory.aspx.cs" Inherits="join.pms.web.Disk.NewAddDirectory" %>
    ...
    <td height="180" valign="top" class="dxx">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="20" class="page">请输入文件夹名称</td>
          </tr>
          <tr>
            <td width="80" align="right" class="page"></td>
            <td height="30" class="page"><asp:TextBox ID="txtDirectoryName" runat="server" CssClass="cuserinput"></asp:TextBox></td>
          </tr>
          <tr>
            <td width="80" align="right" class="page"></td>
            <td height="20" class="page">请选择文件夹位置</td>
          </tr>
          <tr>
            <td width="80" align="right" class="page"></td>
            <td height="30"><asp:Literal ID="LiteralSel" runat="server" ></asp:Literal></td>
          </tr>
          <tr>
