<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveFile.aspx.cs" Inherits="join.pms.web.Disk.MoveFile" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>请选择要移动到的文件夹</title>
<base target="_self">
    ...
    <td height="180" valign="top" class="dxx">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="30" class="page">请选择要移动到的文件夹</td>
          </tr>
          <tr>
            <td width="80" align="right" class="page"></td>
          ...
          <tr>
            ...
            <input id="Button1" onclick="javascript:window.close();" type="button" value=" 取消 " class="cuserreset" />
            </td>
          </tr>
        </table></div>
        </td>
