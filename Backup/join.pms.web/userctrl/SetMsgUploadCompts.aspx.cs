...
{
    public partial class SetMsgUploadCompts : System.Web.UI.Page
    {
        ...
        private void SaveFileToDB(string docsType, string docsPath, string sourceName)
        {
            try
            {
                // SELECT [DocID], [DocsType], [DocsPath], [SourceName], [UserID], [OprateDate] FROM [NMG_TLS_KLQ_OC_DB].[dbo].[SYS_MsgDocs]
                m_SqlParams = "INSERT INTO [SYS_MsgDocs](DocsType,DocsPath,SourceName,UserID) ";
