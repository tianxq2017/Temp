...
{
    public partial class ucDataAreaSel : System.Web.UI.UserControl
    {
        ...
        protected void DropDownListXiang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(areaCode))
            {
                ...
                this.txtSelectArea.Text = this.DropDownListXiang.SelectedItem.Text;
        ...
        protected void DropDownListCun_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(areaCode))
            {
                this.txtSelectArea.Text = this.DropDownListXiang.SelectedItem.Text + this.DropDownListCun.SelectedItem.Text;
