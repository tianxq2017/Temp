...
{
    public partial class ucDataAreaSelInoculationPoint : System.Web.UI.UserControl
    {
        ...
        protected void DropDownListCun_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(areaCode))
            {
                ...
                txtSelPointCode.Value = this.DropDownListCun.SelectedItem.Value;
            }
        }
        ...
        {
            string areaCode = this.txtSelPointCode.Value;
            if (!String.IsNullOrEmpty(areaCode))
            {
                return areaCode;
            }
