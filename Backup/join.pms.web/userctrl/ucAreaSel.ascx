<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAreaSel.ascx.cs" Inherits="join.pms.web.userctrl.ucAreaSel" %>
...
<br/>
<div class="text text_t"><p><span><asp:TextBox ID="txtSelectArea" runat="server" EnableViewState="False" MaxLength="35" Width="300px"/></span></p></div>
<input type="hidden" name="txtSelAreaCode" id="txtSelAreaCode" value="" EnableViewState="False"  runat="server" style="display:none;"/>
<!------end--------->
