<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biz0109.aspx.cs" Inherits="join.pms.wap.SceneSvrs.Biz0109" %>
...
<body>
    ...
    <div class="block"> 
        ...
        <!--相关内容 -->
        <div class="part_05">
            <div class="part_name">《流动人口婚育证明》申请审核</div>

            <div class="part_form">
              <div class="part_title"><span class="fr">∨</span>持证人信息</div>
              <ul>
                  <li>
                  ...
                  <li>
                    ...
                    <p class="select"><asp:DropDownList ID="ddlMarryTypeA" runat="server" onchange="ShowMarry0109();">
                    ...
                    <li>
                    <p class="title"><span class="xing">*</span>婚姻变动日期</p>
                    <p class="text"><input id="txtFileds34" runat="server"  onclick="SelectDate(document.getElementById('txtFileds34'),'yyyy-MM-dd')" readonly="readonly"  /></p>
                  </li>
                  <li>
            ...
            <div class="part_form">
              <div class="part_title"><span class="fr">∨</span><span class="xing">*</span>避孕措施</div>
              <ul>
                <li>
            ...
            <div id="panelChildren" style="display:none;" class="part_form">
     	    ...
     	    <div class="part_form">
              <div class="part_title"><span class="fr">∨</span><span class="xing">*</span>承诺</div>
              <ul>
                <li>
                  <p class="text"><asp:TextBox ID="txtFileds18" runat="server" EnableViewState="False" MaxLength="100" Text="本人保证以上提供的相关情况属实。如有不实，持证人愿意承担由此引起的相应法律责任。"/></p>
                </li>	
              </ul>
            </div>
