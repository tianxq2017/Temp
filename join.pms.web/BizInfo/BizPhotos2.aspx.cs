...
{
    public partial class BizPhotos2 : System.Web.UI.Page
    {
        ...
        private void ShowBizInfo(string bizID)
        {
            ...
            try
            {
                ...
                sqlParams = "SELECT TOP 12 DocsType,DocsPath,SourceName,DocsName,OprateDate,IsInnerArea FROM BIZ_Docs WHERE BizID=" + bizID + " ORDER BY CommID";
