<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xmlImport.aspx.cs" Inherits="join.pms.dalInfo.xmlImport" %>
...
<tr class="zhengwen">
    <td width="150" align="right" height="50" class="zhengwenjiacu">3、执行采集：</td>
    <td align="left" width="*" class="small"><asp:Button ID="butImport" runat="server"  Text="采集..." OnClick="butImport_Click"  />&nbsp;    </td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<br/>
