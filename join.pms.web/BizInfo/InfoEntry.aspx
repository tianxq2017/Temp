<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoEntry.aspx.cs" Inherits="join.pms.web.BizInfo.InfoEntry" %>
                                            ...
                                            <table width="800px" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="text">
                                                        <p>
                                                            <span>
                                                                <asp:TextBox ID="txt_FileName" runat="server" EnableViewState="False" MaxLength="25" />
                                                            </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text">
                                                        <p>
                                                            <span>
                                                                <asp:TextBox ID="txt_SourceFunds" runat="server" EnableViewState="False" MaxLength="25" />
                                                            </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text">
                                                        <p>
                                                            <span>
                                                                <asp:TextBox ID="txt_TotalAmount" runat="server" EnableViewState="False" MaxLength="25" />
                                                            </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            ...
                                            <table width="900px" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="text" colspan="6">
                                                        <p>
                                                            <span>
                                                                <asp:TextBox ID="txt_PaymentPlan" runat="server" EnableViewState="False" MaxLength="25" />
                                                            </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th style="width: 70px">
                                                ...
                                                <tr id="tr_2_1" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_1" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_2" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_2" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_3" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_3" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_4" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_4" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_5" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_5" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_6" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_6" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_7" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_7" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_8" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_8" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_9" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_9" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_10" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_10" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_11" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_11" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_12" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_12" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_13" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_13" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_14" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_14" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_15" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_15" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_16" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_16" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_17" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_17" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_18" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_18" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
                                                ...
                                                <tr id="tr_2_19" style="display: none">
                                                    ...
                                                    <td class="select">
                                                        <p>
                                                            <span>
                                                                <asp:DropDownList ID="dr_UnitOfUse_19" runat="server"></asp:DropDownList>
                                                            </span>
                                                        </p>
                                                    </td>
                                                    <th>
