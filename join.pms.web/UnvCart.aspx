<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnvCart.aspx.cs" Inherits="join.pms.web.UnvCart" %>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="small">
    ...
    <!--end-->
    <td width="20" align="left" bgcolor="#F4FAFA">&nbsp;</td>
    <td width="70" height="30" align="left" bgcolor="#F4FAFA">数据单位：</td>
    <td width="150" height="30" align="left" bgcolor="#F4FAFA">
    <asp:DropDownList ID="DDLArea" runat="server"></asp:DropDownList>
    </td>
    <td width="20" align="left" bgcolor="#F4FAFA">&nbsp;</td>
    <td width="70" align="left" bgcolor="#F4FAFA"><asp:Button ID="btnAdd" runat="server" Text="查看" class="submit6" OnClick="btnAdd_Click"></asp:Button></td>
    <td align="left" bgcolor="#F4FAFA">&nbsp;</td>
    <td align="left" bgcolor="#F4FAFA">&nbsp;</td>
    </tr>
    <!-------------------------------------------------->
    <%if (m_FuncCode == "0702" || m_FuncCode == "0707"){ %>
    <tr>
    <td width="20" align="left" bgcolor="#F4FAFA">&nbsp;</td>
    <td width="70" height="30" align="left" bgcolor="#F4FAFA">开始日期：</td>
    <td width="150" height="30" align="left" bgcolor="#F4FAFA">
