    ...
    if(parentCode!=null && parentCode.length>0)
    {
        ...
        switch (currentClass)
        {
	        ...
	        case "5":	  
                ...
                document.getElementById("SelectTexts").innerHTML = selectTexts + " > " + parentText;
                document.getElementById("txtSelectArea").value= selectArea + parentText;
                document.getElementById("txtSelCodeIV").value = selectCodes + "@" + parentCode;
                document.getElementById("txtSelTextIV").value = selectTexts + ">" + parentText;
	            break
	        case "6":	  
	            selectCodes = document.getElementById("txtSelCodeIV").value;
                selectTexts = document.getElementById("txtSelTextIV").value;        
                selectArea= document.getElementById("txtSelectArea").value;                
                document.getElementById("SelectCodes").innerHTML = selectCodes + "@" + parentCode;
                document.getElementById("SelectTexts").innerHTML = selectTexts + " > " + parentText;
                document.getElementById("txtSelectArea").value= selectArea + parentText;
...
function GotoSelectDo()
{
    ...
    var urlParams = document.getElementById("txtUrlParams").value;
   // var x = document.getElementById("txtSelCodeIV").value; //县级 document.getElementById("SelectCodes").innerHTML;
    ...
    //alert(currentClass +""+selectInfo);  
    //if(selectInfo.length>2 && parseInt(currentClass)==6)//县
    if(selectInfo.length>2 && parseInt(currentClass)==6)//市\州级
    {   
        //if(w=="0103"){w="0102";}
        navUrl="biz"+w+".aspx?action=add&x="+x+"&sourceUrl="+urlParams;   
