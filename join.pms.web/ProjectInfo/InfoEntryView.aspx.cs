...
{
    public partial class InfoEntryView : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.ltr_P_SourceFunds.Text = PageValidate.Decode(PageValidate.GetTrim(sdr["P_SourceFunds"].ToString()));
                    this.ltr_P_AllMoney.Text = PageValidate.Decode(PageValidate.GetTrim(sdr["P_AllMoney"].ToString()));
                    //this.ltr_P_PaymentPlan.Text = PageValidate.Decode(PageValidate.GetTrim(sdr["P_PaymentPlan"].ToString()));
                    ...
                    {
                        sb_1.Append("<tr style=\"height:30px\">");
                        if (i == 0)
                        {
                    ...
                    sb_2.Append("<tr style=\"height:30px\">");
                    sb_2.Append("<th style=\"width: 100px\"><span class=\"xing\">*</span>支付计划：</th>");
                    sb_2.Append("<td class=\"text\" colspan=\"6\">" + PageValidate.Decode(PageValidate.GetTrim(sdr["P_PaymentPlan"].ToString())) + "</td>");
                    sb_2.Append("</tr>");
