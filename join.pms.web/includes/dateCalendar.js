...
function CalendarInit()				///Create panel
{
	...
	sYear=this.currDate.getYear();//z-index:2;position:absolute;
	htmlAll="<div id='"+this.sDIVID+"' style='display:none;z-index:2;position:absolute;width:"+this.Width+";border:"+this.divBorderCss+";padding:2px;background-color:#FFFFFF'>";
	htmlAll+="<div align='center' style='z-index:2;position:absolute;'>";
	/// Month
	htmloMonth="<select id='"+this.sMONTHID+"' onchange=CalendarMonthChange("+this.instanceName+") style='width:150'>";
	for(i=0;i<12;i++)
	{			
	...
	htmloMonth+="</select>";
	/// Year
	htmloYear="<select id='"+this.sYEARID+"' onchange=CalendarYearChange("+this.instanceName+") style='width:150'>";
	...
	htmloDayTable+="<tbody bgcolor='#ffffff'style='font-size:13px;z-index:2;position:absolute;'>";
	for(i=0;i<=6;i++)
	{
		if(i==0)
	...
	htmloButton+="<button style='width:150;border:1px solid #BCD0DE;background-color:#eeeeee;cursor:hand'"
