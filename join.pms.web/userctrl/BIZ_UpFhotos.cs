...
namespace join.pms.web.userctrl
{
    public class BIZ_UpFhotos
    {
        ...
        /// 上传签名/签章图片
        /// </summary>
        /// <param name="n">0签名,1签章</param>
        /// <param name="code">区划</param>
        /// <param name="photoPath">返回上传图片相对网站根目录的路径</param>
        /// <returns></returns>
        public static bool UploadUSign(FileUpload ctr, ref string[] bizDocsInfo, string n, string code, ref string msg)
        {
            ...
            if (ctr.HasFile)
            {
                try
                {
                    ...
                    if (IsAllowedFiles(fileContentType))
                    {
                        ...
                        if (fileSize < 10240)
                        {
                            //签名  /images/nsign/区划前6位/区划_ID.括展名
                            //签章  /images/sign/区划前6位/区划_ID.括展名
