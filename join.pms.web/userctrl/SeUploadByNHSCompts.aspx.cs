...
{
    public partial class SeUploadByNHSCompts : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            m_FuncCode = HttpUtility.UrlDecode(PageValidate.GetTrim(Request.QueryString["funcCode"]));
            try
            {
                m_ObjID = Session["txtNHSID"].ToString();
            }
            catch { }
        ...
        private void SaveFileToDB(string docsType, string docsPath, string sourceName)
        {
            try
            {
                m_SqlParams = "INSERT INTO [NHS_Docs](NHSID,funcCode,PersonID,DocsName,DocsType,DocsPath,SourceName,SysNo) ";
                m_SqlParams += "VALUES(" + m_ObjID + ",'" + m_FuncCode + "'," + m_UserID + ",'" + m_DocsName + "','" + docsType + "', '" + docsPath + "', '" + sourceName + "',1) ";
