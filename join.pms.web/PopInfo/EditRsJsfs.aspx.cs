...
{
    public partial class EditRsJsfs : System.Web.UI.Page
    {
        ...
        private void ValidateParams()
        {
            ...
            if (!string.IsNullOrEmpty(m_SourceUrl) && !string.IsNullOrEmpty(m_ActionName))
            {
                ...
                m_NavTitle = "机关事业单位退休人员一次性抚恤金、丧葬费申请信息";
            }
            else
            {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "\"FILEDS01\",\"FILEDS02\",\"FILEDS03\",\"FILEDS04\",\"FILEDS05\",\"FILEDS06\",\"FILEDS07\",\"FILEDS08\",\"REPORTDATE\"";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "\"FILEDS01\" ='" + Fileds01 + "',\"FILEDS02\" ='" + Fileds02 + "',\"FILEDS03\" ='" + Fileds03 + "',\"FILEDS04\" ='" + Fileds04 + "',\"FILEDS05\" ='" + Fileds05 + "',\"FILEDS06\" ='" + Fileds06 + "',\"FILEDS07\" ='" + Fileds07 + "',\"FILEDS08\" ='" + Fileds08 + "',\"REPORTDATE\" ='" + ReportDate + "' ";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了机关事业单位社会养老保险管理办公室下的<机关事业单位退休人员一次性抚恤金、丧葬费申请信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('机关事业单位退休人员一次性抚恤金、丧葬费申请信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
