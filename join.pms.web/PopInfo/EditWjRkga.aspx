<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWjRkga.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.EditWjRkga" %>

<%@ Register Src="../userctrl/ucAreaSel.ascx" TagName="ucAreaSel" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>卫计全员人口个案基础信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列全员人口个案基础信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<tr class="zhengwen">
  ...
  <td align="left">
      <uc2:ucAreaSel id="UcAreaSel1" runat="server">
      </uc2:ucAreaSel></td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
...
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">小区/组名：</td>
...
<tr class="zhengwen">
    ...
    <td align="left" width="*"><input id="txtFileds07" readonly="readonly" size="9" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" /></td>
</tr>
<tr class="zhengwen">
...
<tr class="zhengwen">
    ...
    <td align="left" width="*"><input id="txtFileds12" readonly="readonly" size="9" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" /></td>
</tr>
<tr class="zhengwen">
...
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">配偶身份证号：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds17" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">

<td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">民政优抚：</td>
 <td align="left" width="*">
 
 <asp:CheckBoxList ID="CheckBoxList_MZYF" runat="server" RepeatDirection="Horizontal" RepeatColumns="8"  EnableTheming="True" RepeatLayout="Flow">
                            <asp:listitem text="空巢老人"  Value="0201" />
                            <asp:listitem text="高龄老人" Value="0202" />
                            <asp:listitem text="留守儿童" Value="0203" />
                            <asp:listitem text="低保人员" Value="0204" />
                            <asp:listitem text="三无人员" Value="0205" />
                            <asp:listitem text="残疾人" Value="0206" />
                            <asp:listitem text="双拥人员" Value="0207" />
                            <asp:listitem text="优抚人员" Value="0208" />
                         </asp:CheckBoxList>
...
配偶姓名,配偶身份证号,父亲姓名,父亲身份证号,母亲姓名,
FILEDS16,FILEDS17,FILEDS18,FILEDS19,FILEDS20,
母亲身份证号,居住状况,落户地区
FILEDS21,FILEDS22,FILEDS23
-->
<tr class="zhengwen">
...
<tr class="zhengwen">
  <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">居住状况：</td>
  <td align="left" width="300" ><asp:TextBox ID="txtFileds22" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  <td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">落户地区：</td>
