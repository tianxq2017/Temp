<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XlsPisImp.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.XlsPisImp" %>
...
<tr class="zhengwen">
  <td width="150" height="30" align="right" class="zhengwenjiacu" valign="middle">3、数据单位：</td>
  <td width="*" align="left">
      <uc1:ucAreaSel ID="UcAreaSel1" runat="server" />(区分数据归属区划单位,以有效识别数据归属区划)
