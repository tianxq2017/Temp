...
{
    public partial class editEdu : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">管理首页</a> &gt;&gt; 教体局 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.UcAreaSel03.SetAreaName(sdr["Fileds03"].ToString());
                    this.UcAreaSel04.SetAreaName(sdr["Fileds04"].ToString());
                    this.txtFileds05.Text = PageValidate.GetTrim(sdr["Fileds05"].ToString());
                    this.UcAreaSel06.SetAreaName(sdr["Fileds06"].ToString());
                    ...
                    this.DDLFileds13.Text = PageValidate.GetTrim(sdr["Fileds13"].ToString());
                    ...
                    this.UcAreaSel16.SetAreaName(sdr["Fileds16"].ToString());
                    ...
                    this.UcAreaSel20.SetAreaName(sdr["Fileds20"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds03 = PageValidate.GetTrim(this.UcAreaSel03.GetAreaName());
            ...
            string Fileds06 = PageValidate.GetTrim(this.UcAreaSel06.GetAreaName());
            ...
            string Fileds13 = PageValidate.GetTrim(this.DDLFileds13.Text);
            ...
            string Fileds20 = PageValidate.GetTrim(this.UcAreaSel20.GetAreaName());
            string Fileds21 = PageValidate.GetTrim(this.txtFileds21.Text);   
          
          
            //<!--学号,学籍号,姓名,性别,出生日期,身份证号,政治面貌,民族,籍贯,学生来源,户籍详细地址,学籍状态-->
            ...
            if (m_ActionName == "add")
            {
                m_SqlParams = "SELECT COUNT(*) FROM PIS_BaseInfo WHERE FuncNo='" + m_FuncCode + "' AND CONVERT(varchar(4),ReportDate,126)=CONVERT(varchar(4),'" + ReportDate + "',126) AND Fileds01='" + Fileds01 + "'";
                if (DbHelperSQL.GetSingle(m_SqlParams).ToString() != "0")
                {
                    m_SqlParams = "";
                    Response.Write(" <script>alert('" + Fileds01 + "已经存在本年度数据；无需重复添加；需要修改请操作“编辑”功能！') ;window.location.href='" + m_TargetUrl + "'</script>");
                    return;
                }
                ...
                m_SqlParams += "Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,Fileds16,Fileds17,Fileds18,Fileds19,Fileds20,Fileds21,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14, Fileds15, Fileds16, Fileds17, Fileds18, Fileds19, Fileds20, Fileds21 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了教体局下的<学龄前儿童入学登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('学龄前儿童入学登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
