<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata0701.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.chatdata0701" %>
...
<table width="880" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
  <tr >
    <td colspan="3" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">期末总人口：</td>
    <td><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
  <tr >
    <td width="30" rowspan="9" align="center" bgcolor="#FFFFCC">出<br/>生<br/>人<br/>口</td>
    <td width="30" rowspan="3" align="center" bgcolor="#FFFFCC">一孩</td>
    <td width="60" align="right" bgcolor="#FFFFCC">总计：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="3" align="center" bgcolor="#FFFFCC">二孩</td>
  ...
  <tr>
    <td rowspan="3" align="center" bgcolor="#FFFFCC">多孩</td>
    <td align="right" bgcolor="#FFFFCC">总计：</td>
  ...
  <tr>
    <td colspan="3" align="right" bgcolor="#99FFFF" class="zhengwenjiacu">死亡人数：</td>
