                ...
                while (sdr.Read())
                {
                    ...
                    switch (this.m_FuncCode)
                    {
                        case "1101":
                            ...
                            s.Append("    </tr>");
                            s.Append("     <tr>");
                            s.Append("       <td colspan=\"8\" class=\"t_l font20\" style=\"line-height:28px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根据《陕西省人口与计划生育条例》第二十二条规定：实行生育第一胎子女登记制度。经核实：该夫妇属于政策内一胎怀孕/生育。</td>");
                            s.Append("    </tr>");
                            s.Append("	  <tr>");
                        ...
                        case "1104":
                            ...
                            s.Append("        </tr>");
                            s.Append("        <tr>");
                            s.Append("          <td colspan=\"2\" align=\"right\" class=\"bt_03\">宜川县人口和计划生育委员会</td>");
                            s.Append("        </tr>");
                            s.Append("        <tr>");
                        ...
                        case "1106":
                            ...
                            s.Append("      <td class=\"left\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
                            s.Append("        <tr>");
                            s.Append("          <td colspan=\"2\" align=\"center\" class=\"bt_01\">宜川县人口计生委<br />出生婴儿实名登记单（存根）</td>");
                            s.Append("        </tr>");
                            s.Append("        <tr class=\"bt_02\">");
