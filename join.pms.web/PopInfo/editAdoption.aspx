<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editAdoption.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editAdoption" %>
...
<tr class="zhengwen">
    ...
    <td width="100" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">妻子姓名：</td>
...
<tr class="zhengwen">
    ...
    <td align="left" width="300"><asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" MaxLength="18" Width="200px"/></td>
    <td align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">身份证号：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="18" Width="200px"/></td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100" bgcolor="#FFFFCC">家庭住址：</td>
    <td align="left" width="*">
 <uc2:ucAreaSel ID="UcAreaSel05" runat="server" />
    </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">结婚登记时间：</td>
  <td align="left"><input id="txtFileds06" readonly="readonly" size="29" onclick="PopCalendar(txtFileds06);return false;"  runat="server" />
    <input id="CalendarStart2" onclick="PopCalendar(txtFileds06);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" /></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">原有子女数：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">联系电话：</td>
  <td align="left"><asp:TextBox ID="txtFileds08" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">被收养人姓名：</td>
  <td align="left"><asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">性别：</td>
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">出生日期：</td>
  <td align="left"><input id="txtFileds11" readonly="readonly" size="29" onclick="PopCalendar(txtFileds11);return false;"  runat="server" />
    <input id="CalendarStart3" onclick="PopCalendar(txtFileds11);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" /></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">家庭住址：</td>
  <td align="left">
      <uc2:ucAreaSel ID="UcAreaSel12" runat="server" />
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">备注：</td>
