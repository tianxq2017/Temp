...
{
    public partial class EditJyXsrx : System.Web.UI.Page
    {
...
Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,,Fileds06,Fileds07,Fileds08
            ...
            if (!String.IsNullOrEmpty(Fileds03) && !ValidIDCard.VerifyIDCard(Fileds03))
            {
                strErr += "身份证号有误！！\\n";
            }
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了教育局下的<学生入学登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('学生入学登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
