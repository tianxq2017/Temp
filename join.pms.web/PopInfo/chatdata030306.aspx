<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata030306.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.chatdata030306" %>
...
<tr >
  <td align="right" height="25" class="zhengwenjiacu" width="140" bgcolor="#FFFFCC">数据日期：</td>
...
<table width="880" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
  <tr >
    <td width="40" rowspan="9" align="center" bgcolor="#FFFFCC">免费服务手术项目</td>
    <td width="100" align="right" bgcolor="#FFFFCC">放置宫内节育器：</td>
