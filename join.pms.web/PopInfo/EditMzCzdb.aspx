<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMzCzdb.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditMzCzdb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>民政享受城镇低保人员信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列享受城镇低保人员信息；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<!--
申请人姓名,身份证号,保障人口,家庭地址,户主性别,所在社区
Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06
-->
<tr class="zhengwen">
...
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu">所在社区：</td>
