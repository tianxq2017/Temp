<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editZanZhuPop.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editZanZhuPop" %>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100" bgcolor="#CCFFFF">暂住证编号：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">公民身份号码：</td>
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">出生日期：</td>
  <td align="left">
  <input id="txtFileds04" readonly="readonly" size="29" onclick="PopCalendar(txtFileds04);return false;"  runat="server" />
    <input id="Image7" onclick="PopCalendar(txtFileds04);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
  </td>
</tr>
<tr class="zhengwen">
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">暂住地址：</td>
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">访查预警：</td>
  <td align="left"><asp:TextBox ID="txtFileds08" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">证件状态：</td>
