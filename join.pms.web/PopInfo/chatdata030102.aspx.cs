...
{
    public partial class chatdata030102 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.txtFileds04.Text = PageValidate.GetTrim(sdr["Fileds04"].ToString());  //姓名
                    this.dd_Fileds05.SelectedValue = PageValidate.GetTrim(sdr["Fileds05"].ToString());  //性别                                                                                
                    this.txtFileds06.Value = PageValidate.GetTrim(sdr["Fileds06"].ToString());  //出生年月
                    this.txtFileds07.Value = PageValidate.GetTrim(sdr["Fileds07"].ToString());  //死亡日期
                    this.txtFileds08.Text = PageValidate.GetTrim(sdr["Fileds08"].ToString());   //死亡原因
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds04 = PageValidate.GetTrim(this.txtFileds04.Text);   //姓名
            string Fileds05 = PageValidate.GetTrim(this.dd_Fileds05.SelectedValue);   //性别
            string Fileds06 = PageValidate.GetTrim(this.txtFileds06.Value);   //出生年月
            string Fileds07 = PageValidate.GetTrim(this.txtFileds07.Value);   //死亡日期
            string Fileds08 = PageValidate.GetTrim(this.txtFileds08.Text);      //死亡原因
            ...
            if (String.IsNullOrEmpty(Fileds04)) { strErr += "请输入姓名！\\n"; }
            if (String.IsNullOrEmpty(Fileds05)) { strErr += "请输入性别！\\n"; }
            if (String.IsNullOrEmpty(Fileds06)) { strErr += "请选择出生年月！\\n"; }
            if (String.IsNullOrEmpty(Fileds07)) { strErr += "请选择死亡日期！\\n"; }
            if (String.IsNullOrEmpty(Fileds08)) { strErr += "请输入死亡原因！\\n"; }
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds17,Fileds18,";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds06 ='" + Fileds06 + "',Fileds07 ='" + Fileds07 + "',Fileds08 ='" + Fileds08 + "',";
                m_SqlParams += "Fileds17 ='" + Fileds17 + "',Fileds18 ='" + Fileds18 + "',";
            ...
            {
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('人口动态信息报告单<一>（死亡情况）数据操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
