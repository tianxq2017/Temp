...
{
    public partial class EditRsYlbx : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">起始页</a> &gt;&gt; 农保办 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "\"FILEDS01\",\"FILEDS02\",\"FILEDS03\",\"FILEDS04\",\"FILEDS05\",\"FILEDS06\",\"FILEDS07\",\"FILEDS08\",\"FILEDS09\",\"FILEDS10\",\"FILEDS11\",\"FILEDS12\",\"FILEDS13\",\"FILEDS14\",\"REPORTDATE\"";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "\"FILEDS01\" ='" + Fileds01 + "',\"FILEDS02\" ='" + Fileds02 + "',\"FILEDS03\" ='" + Fileds03 + "',\"FILEDS04\" ='" + Fileds04 + "',\"FILEDS05\" ='" + Fileds05 + "',\"FILEDS06\" ='" + Fileds06 + "',\"FILEDS07\" ='" + Fileds07 + "',\"FILEDS08\" ='" + Fileds08 + "',\"FILEDS09\" ='" + Fileds09 + "',\"FILEDS10\" ='" + Fileds10 + "',\"FILEDS11\" ='" + Fileds11 + "',\"FILEDS12\" ='" + Fileds12 + "',\"FILEDS13\" ='" + Fileds13 + "',\"FILEDS14\" ='" + Fileds14 + "',\"REPORTDATE\" ='" + ReportDate + "' ";
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了农保办下的<农村社会养老保险记录表>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('农村社会养老保险记录表操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
