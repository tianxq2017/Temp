<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020804.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020804" %>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td  height="25" align="right" class="zhengwenjiacu" width="100">准考证号：</td>
    <td align="left" ><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td  height="25" align="right" class="zhengwenjiacu" width="100">姓名：</td>
