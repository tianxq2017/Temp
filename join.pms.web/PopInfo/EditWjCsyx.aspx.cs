...
{
    public partial class EditWjCsyx : System.Web.UI.Page
    {
...
FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25
            ...
            if (m_ActionName == "add")
            {
                ...
                if (rtv == "0")
                {
                    ...
                    m_SqlParams += "FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,";
                ...
                {
                    MessageBox.Show(this, "出生证编号已存在，不能提交！");
                    return;
                }
            }
            ...
            {
                //判断儿童编码是否重复
                string rtv1 = CommPage.GetSingleVal("select CommID from PIS_BASEINFO where FuncNo='01010112' and FILEDS01='" + Fileds01 + "'");
                if (rtv1 == m_ObjID)
                {
                ...
                {
                    string rtv2 = CommPage.GetSingleVal("select count(0) from PIS_BASEINFO where FuncNo='01010112' and FILEDS01='" + Fileds01 + "'");
                    if (rtv2 == "0")
                    {
                        m_SqlParams = "UPDATE PIS_BASEINFO SET ";
                        m_SqlParams += "FILEDS01 ='" + Fileds01 + "',FILEDS02 ='" + Fileds02 + "',FILEDS03 ='" + Fileds03 + "',FILEDS04 ='" + Fileds04 + "',FILEDS05 ='" + Fileds05 + "',";
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫计局下的<出生医学证明办理信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('出生医学证明办理信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
