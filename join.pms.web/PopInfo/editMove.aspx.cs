...
{
    public partial class editMove : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.txtFileds01.Value = PageValidate.GetTrim(sdr["Fileds01"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds01 = PageValidate.GetTrim(this.txtFileds01.Value);
            ...
            //姓名,性别,身份证号码,婚姻状况,联系电话,迁徙类型,迁徙原因,迁出日期,迁出地,迁入日期,迁入地
            ...
            //if (Fileds02 == "迁入") { pis.P_Addres = Fileds07; }
            //else { pis.P_Addres = Fileds06; }
            //pis.P_Nation = "";
            //pis.P_Edu = "";
            //pis.P_Job = "";
            //pis.P_Marry = Fileds09;
            //pis.P_Tel = Fileds10;
            //pis.P_TransType = Fileds02;
            //pis.P_TransDate = Fileds01;
            //pis.P_FatherName = "";
            //pis.P_FatherCID = "";
            //pis.P_MotherName = "";
            //pis.P_MotherCID = "";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了公安局下的<迁移人员登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('迁移人员登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
