...
{
    public partial class edit020201 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.UcAreaSel06.SetAreaName(PageValidate.GetTrim(sdr["Fileds06"].ToString()));
                    ...
                    this.UcAreaSel14.SetAreaName(PageValidate.GetTrim(sdr["Fileds14"].ToString()));
                    ...
                    this.txtFileds17.Value = PageValidate.GetTrim(sdr["Fileds17"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds13 = PageValidate.GetTrim(this.DDLFileds13.SelectedValue);
            string Fileds14 = PageValidate.GetTrim(this.UcAreaSel14.GetAreaName());
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,Fileds16,Fileds17,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds16 ='" + Fileds16 + "',Fileds17 ='" + Fileds17 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "'";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14, Fileds15, Fileds16, Fileds17 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫生局下的<新生儿出生信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('新生儿出生信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
