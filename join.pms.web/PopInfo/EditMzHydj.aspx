<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMzHydj.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditMzHydj" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>民政婚姻登记信息</title>
...
<tr class="zhengwen">
    ...
    <td align="left" width="300"><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="25" Width="200px" onblur="showBirthday('txtFileds05','txtFileds11')"/></td>
    <td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">身份证号：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds13" runat="server" EnableViewState="False" MaxLength="25" Width="200px" onblur="showBirthday('txtFileds13','txtFileds19')"/></td>
</tr>
...
<tr class="zhengwen">
    ...
    <td align="left" width="300">
    <input id="txtFileds11" readonly="readonly" size="29" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" />
    </td>
    <td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">出生日期：</td>
    <td align="left" width="*">
    <input id="txtFileds19" readonly="readonly" size="29" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" />
    </td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
...
<tr class="zhengwen">
    ...
    <td align="left" width="*"><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" MaxLength="25" Width="620px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">女方详细地址：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds15" runat="server" EnableViewState="False" MaxLength="25" Width="620px"/></td>
</tr>
