...
{
    public partial class chatdata030303 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_ActionName == "add")
            {
                ...
                DataTable table = DbHelperSQL.Query("select * from PIS_BaseInfo where FuncNo = '030303' and ReportDate = '" + ReportDate + "' and AreaCode = '" + AreaCode + "'").Tables[0];
            ...
            try
            {
                ...
                //    {
                //        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了基础数据填报下的<石泉县农村、城镇独生子女保健费>：" + returnVal;
