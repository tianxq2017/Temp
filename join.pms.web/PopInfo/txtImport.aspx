<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="txtImport.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.txtImport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Txt文本文件导入</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一按步骤操作；首先选择要上传的文本文件，然后点击“上传”按钮；上传完毕后，再点击“导入”按钮……<br/>导入的数据默认为审核，所以请导入先仔细检查待导入数据……</div>
<!-- 页面参数 -->
