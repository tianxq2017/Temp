...
{
    public partial class edit020701 : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">管理首页</a> &gt;&gt; 统计局 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //string Fileds01 = PageValidate.GetTrim(Request["txtAreaName"]);
            ...
            // 
            if (!String.IsNullOrEmpty(Fileds02)&&!PageValidate.IsNumber(Fileds02)) { strErr += "总户数输入错误！\\n"; }
            if (!PageValidate.IsNumber(Fileds03)) { strErr += "总人口输入错误！\\n"; }
            if (!String.IsNullOrEmpty(Fileds04)&&!PageValidate.IsNumber(Fileds04)) { strErr += "男性人口输入错误！\\n"; }
            if (!String.IsNullOrEmpty(Fileds05)&&!PageValidate.IsNumber(Fileds05)) { strErr += "女性人口输入错误！\\n"; }
            if (!PageValidate.IsNumberFormat(Fileds06)) { strErr += "非农人口数输入错误！\\n"; }
            if (!PageValidate.IsNumberFormat(Fileds07)) { strErr += "农业人口数输入错误！\\n"; }
            if (!PageValidate.IsNumberFormat(Fileds08)) { strErr += "人均纯输入输入错误！\\n"; }
            if (strErr != "")
            {
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds06 ='" + Fileds06 + "',Fileds07 ='" + Fileds07 + "',Fileds08 ='" + Fileds08 + "',Fileds09 ='" + Fileds09 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "'";
            ...
            try
            {
                ...
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了统计局下的<总户数、总人口信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('总户数、总人口信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
