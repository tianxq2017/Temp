<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editTrain.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editTrain" %>
...
<tr class="zhengwen">
  ...
  <td align="left">
      <uc1:ucAreaSelXian ID="UcAreaSelXian04" runat="server" />
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">学历：</td>
  <td align="left"><asp:DropDownList ID="DDLFileds05" runat="server">
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" width="150">毕业时间：</td>
  <td align="left">
    <input id="txtFileds06" readonly="readonly" size="29" onclick="PopCalendar(txtFileds06);return false;"  runat="server" />
    <input id="Image1" onclick="PopCalendar(txtFileds06);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
  </td>
</tr><!--姓名,性别,身份证号,家庭住址,学历,毕业时间,参加劳动技能培训时间,备注,数据日期,状态-->
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">参加技能培训时间：</td>
  <td align="left"><input id="txtFileds07" readonly="readonly" size="29" onclick="PopCalendar(txtFileds07);return false;"  runat="server" />
    <input id="Image3" onclick="PopCalendar(txtFileds07);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" /></td>
</tr>
<tr class="zhengwen">
