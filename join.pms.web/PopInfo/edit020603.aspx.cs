...
{
    public partial class edit020603 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            // <!--公民身份号码,姓名,出生日期,性别,人员状态,户口性质,收缴方式,所属乡镇(街道)代码,所属乡镇(街道)名称,村(社区)编号,村(社区)名称,享受待遇标志-->
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了人社局下的<计生户社会养老参保信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('计生户社会养老参保信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
