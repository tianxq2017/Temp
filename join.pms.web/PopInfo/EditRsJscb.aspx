<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EditRsJscb.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditRsJscb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>人社局-机关事业单位在职人员社会养老参保信息</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <!--提示信息-->
        <div class="tsxx">
            提示信息：请逐一填写下列机关事业单位在职人员社会养老参保信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
        <!-- 页面参数 -->
                                    ...
                                    <table width="880" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <tr class="zhengwen">
                                            <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">
                                                姓名：</td>
                                            <td align="left">
                                                <asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" Width="200px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
