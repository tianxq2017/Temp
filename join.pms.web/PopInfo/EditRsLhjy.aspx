<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EditRsLhjy.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditRsLhjy" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>人社局-就业困难人员登记表</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <!--提示信息-->
        <div class="tsxx">
            提示信息：请逐一填写下列就业困难人员登记表后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
        <!-- 页面参数 -->
                            ...
                            <tr>
                                <td bgcolor="#F3FCFF" align="left">
                                    ...
                                    <table width="880" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <tr class="zhengwen">
                                            <td align="right" bgcolor="#ccffff" class="zhengwenjiacu" width="100" height="25">
                                                出生年月：</td>
                                            <td align="left">
                                        ...
                                        <tr class="zhengwen">
                                            <td align="right" bgcolor="#ccffff" class="zhengwenjiacu" width="100" height="25">
                                                家庭住址：</td>
                                            <td align="left">
                                                <asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td align="right" bgcolor="#ccffff" class="zhengwenjiacu" width="100" height="25">
                                                就业意向：</td>
                                            <td align="left">
                                                <asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td width="100" height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">
                                                培训意向：</td>
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" width="100" class="zhengwenjiacu">
                                                人员类别：</td>
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" width="100" class="zhengwenjiacu">
                                                推荐岗位：</td>
                                        ...
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" width="100" class="zhengwenjiacu">
                                                享受扶持<br />政策内容：</td>
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" width="100" class="zhengwenjiacu">
                                                联系电话：</td>
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" width="100" class="zhengwenjiacu">
                                                单位：</td>
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds11" runat="server" EnableViewState="False" Width="500px" /></td>
                                        </tr>                                        
                                    </table>
                                    <table width="880" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
