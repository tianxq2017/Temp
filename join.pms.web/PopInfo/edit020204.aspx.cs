...
{
    public partial class edit020204 : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">管理首页</a> &gt;&gt; 卫计局 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.DropDownList08.Text = PageValidate.GetTrim(sdr["Fileds08"].ToString());
        ...
        private void PubInfo(string objID)
        {
            try
            {
                // AuditFlag:0 默认;1 审核; 2,修改 4 删除; 9 公开
                string cmsAttrib = string.Empty;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds08 = PageValidate.GetTrim(this.DropDownList08.Text);
            ...
            {
                m_SqlParams = "UPDATE PIS_BaseInfo SET AuditFlag=2,";
            ...
            try
            {
                if (m_ActionName == "edit") {
                    ...
                    if (!string.IsNullOrEmpty(returnVal)) {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫计局下的<合作医疗兑现情况>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('合作医疗兑现情况操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
