<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editMedOP.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editMedOP" %>
...
<tr class="zhengwen">
  ...
  <td align="left">
      <uc1:ucAreaSel ID="UcAreaSel03" runat="server" />
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">手术名称：</td>
  <td align="left">
    <asp:DropDownList ID="DDLFileds04" runat="server">
    <asp:ListItem>放置宫内节育器</asp:ListItem>
    <asp:ListItem>取出宫内节育器</asp:ListItem>
    <asp:ListItem>人工流产</asp:ListItem>
    <asp:ListItem>引产</asp:ListItem>
    <asp:ListItem>自然流产</asp:ListItem>
    <asp:ListItem>放置皮下埋置剂</asp:ListItem>
    <asp:ListItem>取出皮下埋置剂</asp:ListItem>
    <asp:ListItem>药具</asp:ListItem>
    <asp:ListItem>男性绝育</asp:ListItem>
    <asp:ListItem>女性绝育</asp:ListItem>
    </asp:DropDownList>
  </td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">施术日期：</td>
    <td align="left" width="*">
    <input id="txtFileds05" readonly="readonly" size="29" onclick="PopCalendar(txtFileds05);return false;"  runat="server" />
    <input id="CalendarStart2" onclick="PopCalendar(txtFileds05);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
    </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">施术单位：</td>
