<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020304.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020304" %>
...
<tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">所在乡镇：</td>
    <td align="left"><uc1:ucAreaSel ID="UcAreaSel04" runat="server" /></td>
 </tr>
 <tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">所在村组：</td>
