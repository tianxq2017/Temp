<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRsNbzy.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditRsNbzy" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>人社局-新农保转移</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列新农保转移后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" width="120"  bgcolor="#CCFFFF">
      公民身份号码：</td>
...
<tr class="zhengwen">
  ...
  <td align="left">
    ...
    <tr class="zhengwen">
    <td width="120" height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">
        转入村(社区)：</td>
