<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editKuanFa.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editKuanFa" %>
...
<tr class="zhengwen">
  ...
  <td align="left"><uc1:ucAreaSelXian ID="UcAreaSelXian04" runat="server" /></td>
</tr>
<tr class="zhengwen">
...
</tr><!--姓名,性别,身份证号,家庭住址,学历,毕业时间,支持创业贴息贷款额度,备注,数据日期,状态-->
<tr class="zhengwen">
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">参加劳动技能培训时间：</td>
  <td align="left"><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">支持创业贴息贷款额度：</td>
