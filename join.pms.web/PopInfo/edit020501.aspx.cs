...
{
    public partial class edit020501 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            /*
企业名称,注册号,法定代表人,成立日期,登记机关,管辖单位,企业类型,注册资本,核准日期,档案号,
行业,经营范围,经营截止日期,经营地址,电话,身份证,吊销时间,国别地区,注册资本总和,企业数,从业人员总和
             */
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds16 ='" + Fileds16 + "',Fileds17 ='" + Fileds17 + "',Fileds18 ='" + Fileds18 + "',Fileds19 ='" + Fileds19 + "',Fileds20 ='" + Fileds20 + "',Fileds21 ='" + Fileds21 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "'";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了工商局下的<办理工商管理证件的人员信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('办理工商管理证件的人员信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
