<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011402.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011402" %>
...
<br/>
    ...
    <div style="font-size:28px; text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>（半）年已婚育龄妇女孩次、节育情况 </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="1" >
    <tr style="font-size:14px;">
    <td>机构：<%=str_UnitName%></td>
