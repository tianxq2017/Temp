<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03010702.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03010702" %>
...
<!-- 编辑区  -->
<br/>
    <div style="font-size:28px; text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>年度人口与出生情况</div>
