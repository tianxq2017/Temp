<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011701.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011701" %>
...
<head id="Head1" runat="server">
    <title>年度陕西省计划生育家庭情况统计表（农村）一填报</title>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
    <p style="font-size:18px; text-align:center; font-weight:bold"><input id="txt_RptTime" readonly="readonly"  size="4" onclick="JTC.setday({format:'yyyy年', readOnly:true})" runat="server" />年度陕西省计划生育家庭情况统计表（农村）</p>
    <p><%=str_AreaName%></p>    <table width="100%" border="1" cellpadding="3" cellspacing="1"  style="border-collapse:collapse;bordercolor=#000000">
        <thead>
