<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03013002.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03013002" %>
...
<!-- 编辑区  -->
    <br/>
    <div style="font-size:28px;text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>份人口动态信息报告单<一></div><br/>
