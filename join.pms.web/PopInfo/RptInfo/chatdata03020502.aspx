<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03020502.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03020502" %>
...
<head id="Head1" runat="server">
    <title>儿童营养包改善项目营养包发放统计月报表</title>
...
<!-- 编辑区  -->
<br/>
    <div style="font-size:28px; text-align:center; font-weight:bold">儿童营养包改善项目营养包发放统计月报表（<input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年MM月', readOnly:true})" runat="server" />月）</div>
