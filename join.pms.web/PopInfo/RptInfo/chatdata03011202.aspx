<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011202.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011202" %>
...
<!-- 编辑区  -->
<br/>
    <div style="font-size:28px; text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>（半）年度节育情况 </div>
