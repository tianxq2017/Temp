<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03010901.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03010901" %>
...
<head id="Head1" runat="server">
    <title>（半）年已婚育龄妇女孩次、节育情况 一填报</title>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
    ...
    </asp:DropDownList>年已婚育龄妇女孩次、节育情况 </p>
