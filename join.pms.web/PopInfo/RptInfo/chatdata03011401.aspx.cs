...
{
    public partial class chatdata03011401 : System.Web.UI.Page
    {
        ...
        #region 统计合计
        public int[] arrNum = new int[21];
        public int[] arrNum2 = new int[21];
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    lbl_txtFileds01 = DbHelperSQL.GetSingle("select Count(*) from v_PisQyk where FuncNo = '01010101' and  AreaCode = '" + this.dr_DataAreaSel.SelectedValue + "'").ToString();
                }
                catch
                {
                    lbl_txtFileds01 = "0";
                ...
                try
                {
                    lbl_txtFileds02 = DbHelperSQL.GetSingle("select count(*) from v_BizList where AttribsCN = '通过'").ToString();
                }
                catch
                {
                    lbl_txtFileds02 = "0";
                ...
                try
                {
                    fileds03All = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过'").ToString();
                }
                catch
                {
                    fileds03All = "0";
                ...
                try
                {
                    lbl_txtFileds03 = Convert.ToString(Convert.ToInt32(lbl_txtFileds02) - Convert.ToInt32(fileds03All));
                    if (Convert.ToInt32(lbl_txtFileds03) < 0)
                    {
                        lbl_txtFileds03 = "0";
                    }
                }
                ...
                try
                {
                    lbl_txtFileds04 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0101') and AttribsCN = '通过' and RegAreaNameB like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds04 = "0";
                ...
                try
                {
                    lbl_txtFileds05 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0101') and AttribsCN = '通过' and Fileds17 = '男' and RegAreaNameB like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds05 = "0";
                ...
                try
                {
                    lbl_txtFileds10 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0102') and AttribsCN = '通过' and RegAreaNameB like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds10 = "0";
                ...
                try
                {
                    lbl_txtFileds11 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0102') and AttribsCN = '通过' and (Fileds17 = '女' OR Fileds19 = '女') and RegAreaNameB like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds11 = "0";
                ...
                try
                {
                    lbl_txtFileds17 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and RegAreaNameB like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds17 = "0";
            ...
            else
            {
                ...
                try
                {
                    lbl_txtFileds02 = DbHelperSQL.GetSingle("select * from V_PIS where FuncNo = '01010201' and Fileds15 like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds02 = "0";
