<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011002.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011002" %>
...
<head id="Head1" runat="server">
    <title>（半）年已婚育龄妇女孩次、节育情况（农村） 一查看</title>
...
<br/>
    ...
    <div style="font-size:28px; text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>年已婚育龄妇女孩次、节育情况（农村） </div>
