<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03013202.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03013202" %>
...
<!-- 编辑区  -->
    <br/>
    <div style="font-size:28px;text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>份人口动态信息报告单<二></div><br/>
    ...
    <table width="100%" border="1" cellpadding="3" cellspacing="1"  style="border-collapse:collapse;background-color:#ffffff">
        ...
        <tr style="text-align:center; background-color:#cccccc;">
            <td colspan="15" height="22">婚姻、迁移、流动情况</td>
      ...
      <ItemTemplate>
        <tbody>
            <tr style="text-align:center;">
               <td style="background-color:#ccffff" height="22"><%# join.pms.dal.CommPage.GetSingleVal("select AreaName from AreaDetailCN where AreaCode = '" + Eval("AreaCode").ToString().Substring(0, 9) + "000" + "'")%></td>
...
<!--报表页脚-->
    ...
    <td align="right">填报日期：<asp:TextBox ID="txt_OprateDate" runat="server"></asp:TextBox>&nbsp;</td>
    </tr>
    </table>
    <br/>
