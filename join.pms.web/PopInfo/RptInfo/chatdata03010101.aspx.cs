    ...
    public partial class chatdata03010101 : System.Web.UI.Page
    {
        ...
        private void Rpt_headType(string m_ObjID)
        {
            ...
            if (m_ActionName != "edit" && m_ActionName != "del")
            {
                ...
                {
                    string Is_Exist = join.pms.dal.CommPage.GetSingleVal("select RptID from RPT_Basis where FuncNo = '" + m_FuncCode + "' and RptID!='" + m_ObjID + "' and RptTime = '" + DateTime.Now.ToString("yyyy年MM月") + "'  and Attribs != 4");
                    if (Is_Exist != "")
                    {
