<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03021702.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03021702" %>
...
<!-- 编辑区  -->
<br/>
    <div style="font-size:28px; text-align:center; font-weight:bold">中期引产情况年报表（<input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年', readOnly:true})" runat="server" />年）</div>
