...
<table width="100%" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
   <tr class="zhengwen">
    <td colspan="3" bgcolor="#cccccc">（半）年度节育情况</td>
  </tr>
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC" colspan="2">地区：</td>
  ...
  <tr class="zhengwen">
    <td align="right" bgcolor="#FFFFCC" rowspan="9" width="100">选用各种避孕方法人数</td>
    <td align="right" bgcolor="#FFFFCC" width="100">小计：</td>
  ...
  <tr class="zhengwen">
    ...
    <asp:Label ID="LFileds_txt" runat="server" Text="育龄妇女人数,本期实行计划生育手术例数小计,选用各种避孕方法人数男性绝育,本期实行计划生育手术例数男性绝育,选用各种避孕方法人数女性绝育,本期实行计划生育手术例数女性绝育,选用各种避孕方法人数放置宫内节育器,本期实行计划生育手术例数放置宫内节育器,选用各种避孕方法人数皮下埋植,本期实行计划生育手术例数取出宫内节育器,选用各种避孕方法人数口服及注射避孕药,本期实行计划生育手术例数人工流产,选用各种避孕方法人数避孕套,本期实行计划生育手术例数皮下埋植,选用各种避孕方法人数外用药,选用各种避孕方法人数其它" style="display:none"></asp:Label>
