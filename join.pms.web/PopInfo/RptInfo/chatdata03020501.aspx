<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03020501.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03020501" %>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
    <p style="font-size:18px; text-align:center; font-weight:bold">儿童营养包改善项目营养包发放统计月报表（<input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年MM月', readOnly:true})" runat="server" />月）</p>
    <p><%=str_UnitName%></p>
