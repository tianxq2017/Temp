...
namespace join.pms.web.RptInfo
{
    public partial class chatdata030106 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string txt_OprateDate = PageValidate.GetTrim(Convert.ToDateTime(this.txt_OprateDate.Value).ToString("yyyy-MM-dd"));
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "FuncNo,AreaCode,AreaName,RptName,UnitName,SldHeader,SldLeader,UserID,RptUserName,CreateDate,OprateDate";
                m_SqlParams += ") VALUES(";
                m_SqlParams += "'" + m_FuncCode + "','" + AreaCode + "','" + AreaName + "','" + m_NavTitle + "','" + txt_UnitName + "','" + txt_SldHeader + "','" + txt_SldLeader + "','" + m_UserID + "','" + m_UserName + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + txt_OprateDate + "'";
                m_SqlParams += ")";
            }
            else if (m_ActionName == "edit")
            {
                m_SqlParams = "UPDATE RPT_Basis SET ";
                m_SqlParams += "AreaCode='" + AreaCode + "',AreaName='" + AreaName + "',UnitName ='" + txt_UnitName + "',SldHeader ='" + txt_SldHeader + "',SldLeader ='" + txt_SldLeader + "',OprateDate ='" + txt_OprateDate + "'";
