<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata030146.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata030146" %>
...
<head id="Head1" runat="server">
    <title>年度陕西省计划生育家庭情况统计表(城镇)</title>
...
<tr class="zhengwen">
  <td align="right" width="100" class="zhengwenjiacu" height="25" bgcolor="#FFFFCC">报表年季度：</td>
  <td align="left">
   <asp:TextBox ID="txt_RptTime" runat="server" EnableViewState="False" MaxLength="25" Width="200px"  />
   <!--onclick="JTC.setday({format:'yyyy年MM月', readOnly:true})" -->
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">填报单位：</td>
  <td align="left">
      <div style="display:none"><uc1:ucDataAreaSel ID="UcDataAreaSel1" runat="server" /></div>
      <asp:TextBox ID="Areaname" runat="server" EnableViewState="False" MaxLength="25" Width="200px" ReadOnly=true/>
  </td>
</tr>
<tr class="zhengwen">
