...
{
    public partial class chatdata03011801 : System.Web.UI.Page
    {
        ...
        public int[] arrNum2 = new int[20];
        #endregion

        #region 页面中的信息来源的提示参数
        public string lbl_txtFileds01 = "0";
        public string lbl_txtFileds01_1 = "0";
        public string lbl_txtFileds02 = "0";
        public string lbl_txtFileds02_1 = "0";
        public string lbl_txtFileds03 = "0";
        public string lbl_txtFileds03_1 = "0";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    lbl_txtFileds01 = DbHelperSQL.GetSingle("select count(*) from V_PIS where FuncNo = '01010111' and Fileds04='2'").ToString();
                }
                catch
                {
                    lbl_txtFileds01 = "0";
                ...
                try
                {
                    lbl_txtFileds01_1 = DbHelperSQL.GetSingle("select * from v_BizList where BizCode = '0102' and AttribsCN = '通过' and (Fileds18 > '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).ToString("yyyy-MM-dd") + "' and Fileds18 < '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).AddMonths(1).AddDays(-1).ToString("yyyy-MM-dd") + "')").ToString();
                }
                catch
                {
                    lbl_txtFileds01_1 = "0";
                ...
                try
                {
                    lbl_txtFileds02 = DbHelperSQL.GetSingle("select count(*) from V_PIS where FuncNo = '01010111' and Fileds04='2' and Fileds12 = '男'").ToString();
                }
                catch
                {
                    lbl_txtFileds02 = "0";
                ...
                try
                {
                    lbl_txtFileds02_1 = DbHelperSQL.GetSingle("select * from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '男' and (Fileds18 > '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).ToString("yyyy-MM-dd") + "' and Fileds18 < '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).AddMonths(1).AddDays(-1).ToString("yyyy-MM-dd") + "')").ToString();
                }
                catch
                {
                    lbl_txtFileds02_1 = "0";
                ...
                try
                {
                    lbl_txtFileds03 = DbHelperSQL.GetSingle("select count(*) from V_PIS where FuncNo = '01010111' and Fileds04='2' and Fileds12 = '女'").ToString();
                }
                catch
                {
                    lbl_txtFileds03 = "0";
                ...
                try
                {
                    lbl_txtFileds03_1 = DbHelperSQL.GetSingle("select * from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '女' and (Fileds18 > '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).ToString("yyyy-MM-dd") + "' and Fileds18 < '" + DateTime.Now.AddDays(1 - DateTime.Now.Day).AddMonths(1).AddDays(-1).ToString("yyyy-MM-dd") + "')").ToString();
                }
                catch
                {
                    lbl_txtFileds03_1 = "0";
                ...
                try
                {
                    lbl_txtFileds04 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0102') and AttribsCN = '通过' and RegAreaNameA like '%" + this.dr_DataAreaSel.SelectedValue + "%'").ToString();
                }
                catch
                {
                    lbl_txtFileds04 = "0";
                ...
                try
                {
                    lbl_txtFileds05 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0102') and AttribsCN = '通过' and RegAreaNameA like '%" + this.dr_DataAreaSel.SelectedValue + "%' and Fileds17 = '男'").ToString();
                }
                catch
                {
                    lbl_txtFileds05 = "0";
                ...
                try
                {
                    lbl_txtFileds06 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0102') and AttribsCN = '通过' and RegAreaNameA like '%" + this.dr_DataAreaSel.SelectedValue + "%' and Fileds17 = '女'").ToString();
                }
                catch
                {
                    lbl_txtFileds06 = "0";
                ...
                try
                {
                    lbl_txtFileds11 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>8 and datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<=25").ToString();
                }
                catch
                {
                    lbl_txtFileds11 = "0";
                ...
                try
                {
                    lbl_txtFileds12 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>26 and datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<=35").ToString();
                }
                catch
                {
                    lbl_txtFileds12 = "0";
                ...
                try
                {
                    lbl_txtFileds13 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>36 and datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<=45").ToString();
                }
                catch
                {
                    lbl_txtFileds13 = "0";
                ...
                try
                {
                    lbl_txtFileds14 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>45").ToString();
                }
                catch
                {
                    lbl_txtFileds14 = "0";
