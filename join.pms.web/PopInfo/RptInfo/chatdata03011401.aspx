<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011401.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011401" %>
...
<head id="Head1" runat="server">
    <title>年度已婚育龄妇女孩次、节育情况 一填报</title>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
    <p style="font-size:18px; text-align:center; font-weight:bold"><input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年MM月', readOnly:true})" runat="server" />年度已婚育龄妇女孩次、节育情况 </p>
...
<table width="100%" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
   <tr class="zhengwen">
    <td colspan="4" align="right" bgcolor="#FFFFCC">地区：</td>
  ...
  <tr class="zhengwen">
    <td colspan="4" align="right" bgcolor="#FFFFCC">育龄妇女人数：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="20" align="right" bgcolor="#FFFFCC" width="150">已婚育龄妇女孩次情况</td>
    <td colspan="3" align="right" bgcolor="#FFFFCC">合计：</td>
  ...
  <tr class="zhengwen">
    <td colspan="3" align="right" bgcolor="#FFFFCC">零孩妇女：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="6" align="right" bgcolor="#FFFFCC" width="90">一孩妇女</td>
    <td colspan="2" align="right" bgcolor="#FFFFCC">总数：</td>
  ...
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">其中：独男 户数：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="2" align="right" bgcolor="#FFFFCC" width="100">上环数</td>
    <td align="right" bgcolor="#FFFFCC" width="130">小计：</td>
  ...
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">其中：双女 户数：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="2" align="right" bgcolor="#FFFFCC">绝育数</td>
  ...
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">上环人数：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="5" align="right" bgcolor="#FFFFCC">多孩妇女</td>
    <td colspan="2" align="right" bgcolor="#FFFFCC">总数：</td>
  ...
  <tr class="zhengwen">
    <td rowspan="4" align="right" bgcolor="#FFFFCC">其中</td>
...
<%=js_value %>
    ...
    <asp:Label ID="LFileds_txt" runat="server"  Text="育龄妇女人数,已婚育龄妇女合计,已婚育龄妇女零孩妇女,已婚育龄妇女一孩妇女总数,已婚育龄妇女一孩妇女独男户,已婚育龄妇女一孩妇女上环数小计,已婚育龄妇女一孩妇女上环数独男户,已婚育龄妇女一孩妇女皮埋人数,已婚育龄妇女一孩妇女药具人数,已婚育龄妇女二孩妇女总数,已婚育龄妇女二孩妇女双女户数,已婚育龄妇女二孩妇女绝育数小计,已婚育龄妇女二孩妇女绝育数双女户数,已婚育龄妇女二孩妇女上环人数,已婚育龄妇女二孩妇女皮埋人数,已婚育龄妇女二孩妇女药具人数,已婚育龄妇女多孩妇女总数,已婚育龄妇女多孩妇女绝育人数,已婚育龄妇女多孩妇女上环人数,已婚育龄妇女多孩妇女皮埋人数,已婚育龄妇女多孩妇女药具人数" style="display:none"></asp:Label>
