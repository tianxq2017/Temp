...
{
    public partial class chatdata03010601 : System.Web.UI.Page
    {
        ...
        #region 统计合计
        public int[] arrNum = new int[36];
        public int[] arrNum2 = new int[36];
        #endregion
        ...
        public string lbl_txtFileds04 = "0";
        public string lbl_txtFileds05 = "0";
        public string lbl_txtFileds06 = "0";
        public string lbl_txtFileds07 = "0";
        public string lbl_txtFileds09 = "0";
        public string lbl_txtFileds10 = "0";
        public string lbl_txtFileds11 = "0";
        public string lbl_txtFileds13 = "0";
        public string lbl_txtFileds14 = "0";
        public string lbl_txtFileds15 = "0";
        public string lbl_txtFileds17 = "0";
        public string lbl_txtFileds18 = "0";
        public string lbl_txtFileds19 = "0";

        public string lbl_txtFileds21 = "0";
        public string lbl_txtFileds22 = "0";
        public string lbl_txtFileds23 = "0";
        public string lbl_txtFileds25 = "0";
        public string lbl_txtFileds26 = "0";
        public string lbl_txtFileds27 = "0";
        public string lbl_txtFileds29 = "0";
        public string lbl_txtFileds30 = "0";
        public string lbl_txtFileds31 = "0";
        public string lbl_txtFileds33 = "0";
        public string lbl_txtFileds34 = "0";
        public string lbl_txtFileds35 = "0";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    lbl_txtFileds03 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and Attribs < 2").ToString();
                }
                catch
                {
                    lbl_txtFileds03 = "0";
                ...
                try
                {
                    lbl_txtFileds04 = DbHelperSQL.GetSingle("select count(*) from v_PisQyk where FuncNo = '01010103'").ToString();
                }
                catch
                {
                    lbl_txtFileds04 = "0";
                ...
                #region 本省户籍人数
                if (this.dr_DataAreaSel.SelectedValue != "--请选择--")
                {
                    //本省户籍人数-总出生人数-小计
                    try
                    {
                        lbl_txtFileds05 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds05 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds06 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and Fileds17 = '男' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds06 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds07 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and Fileds17 = '女' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds07 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds09 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds09 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds10 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds10 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds11 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds11 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds13 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds13 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds14 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds14 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds15 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds15 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds17 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds17 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds18 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds18 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds19 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds19 = "0";
                ...
                else
                {
                    ...
                    try
                    {
                        lbl_txtFileds05 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds05 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds06 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and Fileds17 = '男' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds06 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds07 = DbHelperSQL.GetSingle("select * from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and Fileds17 = '女' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds07 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds09 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds09 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds10 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds10 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds11 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds11 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds13 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds13 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds14 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds14 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds15 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds15 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds17 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds17 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds18 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and Fileds17 = '男'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds18 = "0";
                    ...
                    try
                    {
                        lbl_txtFileds19 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and Fileds17 = '女'").ToString();
                    }
                    catch
                    {
                        lbl_txtFileds19 = "0";
                ...
                try
                {
                    lbl_txtFileds21 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%') and AttribsCN = '通过'").ToString();
                }
                catch
                {
                    lbl_txtFileds21 = "0";
                ...
                try
                {
                    lbl_txtFileds22 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%') and Fileds17 = '男' and AttribsCN = '通过'").ToString();
                }
                catch
                {
                    lbl_txtFileds22 = "0";
                ...
                try
                {
                    lbl_txtFileds23 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101' OR BizCode = '0102' OR BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%') and Fileds17 = '女' and AttribsCN = '通过'").ToString();
                }
                catch
                {
                    lbl_txtFileds23 = "0";
                ...
                try
                {
                    lbl_txtFileds25 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds25 = "0";
                ...
                try
                {
                    lbl_txtFileds26 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '男' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds26 = "0";
                ...
                try
                {
                    lbl_txtFileds27 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '女' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds27 = "0";
                ...
                try
                {
                    lbl_txtFileds29 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds29 = "0";
                ...
                try
                {
                    lbl_txtFileds30 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '男' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds30 = "0";
                ...
                try
                {
                    lbl_txtFileds31 = DbHelperSQL.GetSingle("select count(*) from v_BizList where BizCode = '0102' and AttribsCN = '通过' and Fileds17 = '女' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds31 = "0";
                ...
                try
                {
                    lbl_txtFileds33 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds33 = "0";
                ...
                try
                {
                    lbl_txtFileds34 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and Fileds17 = '男' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds34 = "0";
                ...
                try
                {
                    lbl_txtFileds35 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode='0123' OR BizCode='0124' OR BizCode='0125' OR BizCode='0126') and AttribsCN = '通过' and Fileds17 = '女' and (RegAreaNameB not like '%陕西省%' OR RegAreaNameB not like '%安康市%')").ToString();
                }
                catch
                {
                    lbl_txtFileds35 = "0";
        ...
        /// <param name="e"></param>
        protected void dr_DataAreaSel_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            string siteArea = this.dr_DataAreaSel.SelectedValue;
        ...
        private void Rpt_headType(string m_ObjID)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                txt_RptTime.Items.Insert(ii, (Rptnum - i).ToString() + "年第一季");
                ii += 1;
                txt_RptTime.Items.Insert(ii, (Rptnum - i).ToString() + "年第二季");
                ii += 1;
                txt_RptTime.Items.Insert(ii, (Rptnum - i).ToString() + "年第三季");
                ii += 1;
                txt_RptTime.Items.Insert(ii, (Rptnum - i).ToString() + "年第四季");
                ii += 1;
            }
            //设定txt_RptTime选中项
            if (m_ObjID != null)
