...
{
    public partial class chatdata03010201 : System.Web.UI.Page
    {
        ...
        #region 统计合计
        public int[] arrNum = new int[17];
        public int[] arrNum2 = new int[17];
        #endregion
        ...
        private void Rpt_headType(string m_ObjID)
        {
            ...
            if (m_ActionName != "edit" && m_ActionName != "del")
            {
                ...
                {
                    string Is_Exist = join.pms.dal.CommPage.GetSingleVal("select RptID from RPT_Basis where FuncNo = '" + m_FuncCode + "' and RptID!='" + m_ObjID + "' and RptTime = '" + DateTime.Now.ToString("yyyy年MM月") + "'  and AreaCode = '" + str_AreaCode + "' and Attribs != 4");
                    if (Is_Exist != "")
                    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds16 = PageValidate.GetTrim(this.txtFileds16.SelectedValue);
            ...
            {
                int sds = LFileds_type.Text.Split(',').Length;
                int sdsds = LFileds_txt.Text.Split(',').Length;
