<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03011101.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03011101" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>年度人口与出生情况一填报</title>
    <meta http-equiv="Content-type" content="text/html; charset=gb2312" />
        <script language="javascript" src="/includes/jquery-1.9.1.min.js" type="text/javascript"></script>
    <link href="/css/index.css" type="text/css" rel="stylesheet"/>
    <script language="javascript" src="../includes/CommSys.js?v=1.0" type="text/javascript"></script>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
    <p style="font-size:18px; text-align:center; font-weight:bold"><input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年', readOnly:true})" runat="server" />年度人口与出生情况</p>
...
<table width="100%" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
   <tr class="zhengwen">
    <td colspan="4" bgcolor="#cccccc">（半）年度人口与出生情况</td>
  </tr>
  <tr class="zhengwen">
  ...
  <tr class="zhengwen">
    ...
    <td width="300"><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="25" Width="200px" Text="0" onFocus='if (value =="0"){value=""}' onblur='if (value ==""){value="0"}'/></td>
    <td>来源：本表期末常住人口数<span style=" color:#ff9600; font-weight:bold"> <%=lbl_txtFileds01%></span></td>
  </tr>
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">期末常住人口数：</td>
  ...
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">期末已婚育龄妇女人数：</td>
  ...
  <tr class="zhengwen">
    <td colspan="2" align="right" bgcolor="#FFFFCC">期末领取独生子女证人数：</td>
    <td><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="25" Width="200px" Text="0"/></td>
  </tr>
  <tr class="zhengwen">
    <td bgcolor="#cccccc" colspan="4">本期出生人数</td>
  </tr>
  <tr class="zhengwen">
    <td align="right" bgcolor="#FFFFCC" rowspan="3" width="130">一孩出生</td>
  ...
  <tr class="zhengwen">
    <td align="right" bgcolor="#FFFFCC" width="130">女：</td>
  ...
  <tr class="zhengwen">
    ...
    <td>来源：信息共享<span style=" color:#ff9600; font-weight:bold"> 0</span></td>
  </tr>
  <tr class="zhengwen">
...
<%=js_value %>
    ...
    <asp:Label ID="LFileds_txt" runat="server"  Text="期初常住人口数,期未常住人口数,期末已婚育龄妇女人数,期末领取独生子女证人数,本期出生人数一孩男孩出生,本期出生人数一孩女孩出生,本期出生人数一孩计划内出生,本期出生人数二孩男孩出生,本期出生人数二孩女孩出生,本期出生人数二孩计划外出生,本期出生人数多孩男孩出生,本期出生人数多孩女孩出生,本期出生人数多孩计划内出生,往年出生未报人数,女性初婚人数,女性初婚19岁及以下人数,女性初婚23岁及以下人数,死亡人数" style="display:none"></asp:Label>
