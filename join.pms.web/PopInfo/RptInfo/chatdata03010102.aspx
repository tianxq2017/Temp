<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03010102.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03010102" %>
...
<!-- 编辑区  -->
    <br/>
    <div style="font-size:28px;text-align:center; font-weight:bold"><asp:Label ID="txt_RptTime" runat="server" Text="Label"></asp:Label>份人口动态信息报告单<一>（存根）</div><br/>
    ...
    <table width="100%" border="1" cellpadding="3" cellspacing="1"  style="border-collapse:collapse;background-color:#ffffff">
        ...
        <tr style="text-align:center; background-color:#cccccc;">
            <td colspan="13" height="22">婚姻、迁移、流动情况</td>
