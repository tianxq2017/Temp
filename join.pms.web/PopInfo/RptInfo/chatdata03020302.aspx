<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata03020302.aspx.cs" Inherits="join.pms.web.RptInfo.chatdata03020302" %>
...
<!-- 编辑区  -->
<br/>
    <div style="font-size:28px; text-align:center; font-weight:bold">高危孕产妇转诊情况月报表（<input id="txt_RptTime" readonly="readonly"  size="10" onclick="JTC.setday({format:'yyyy年MM月', readOnly:true})" runat="server" />月）</div>
