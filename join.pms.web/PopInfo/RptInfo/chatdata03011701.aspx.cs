...
{
    public partial class chatdata03011701 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    lbl_txtFileds01 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101') and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds01 = "0";
                ...
                try
                {
                    lbl_txtFileds02 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<16 and BizCode = '0101' and Fileds17 = '男' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds02 = "0";
                ...
                try
                {
                    lbl_txtFileds03 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<16 and BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '男' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds03 = "0";
                ...
                try
                {
                    lbl_txtFileds04 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<16 and BizCode = '0101' and Fileds17 = '女' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds04 = "0";
                ...
                try
                {
                    lbl_txtFileds05 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())<16 and BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '女' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds05 = "0";
                ...
                try
                {
                    lbl_txtFileds06 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>16 and BizCode = '0101' and Fileds17 = '男' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds06 = "0";
                ...
                try
                {
                    lbl_txtFileds07 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>16 and BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '男' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds07 = "0";
                ...
                try
                {
                    lbl_txtFileds08 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>16 and BizCode = '0101' and Fileds17 = '女' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds08 = "0";
                ...
                try
                {
                    lbl_txtFileds09 = DbHelperSQL.GetSingle("select count(*) from v_BizList where datediff(year,SUBSTRING(PersonCidB,7,8),getdate())>16 and BizCode = '0101' and AttribsCN = '通过' and Fileds17 = '女' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds09 = "0";
            ...
            else
            {
                ...
                try
                {
                    lbl_txtFileds01 = DbHelperSQL.GetSingle("select count(*) from v_BizList where (BizCode = '0101') and SelAreaCode = '" + this.dr_DataAreaSel.SelectedValue + "' and RegisterType = '农业'").ToString();
                }
                catch
                {
                    lbl_txtFileds01 = "0";
        ...
        {
            this.txt_RptTime.Value = DateTime.Now.ToString("yyyy年");
        }
        /// <summary>
        /// 当前区划下级区划
        /// </summary>
        ...
        private void ValidateParams()
        {
            ...
            if (!string.IsNullOrEmpty(m_SourceUrl) && !string.IsNullOrEmpty(m_ActionName))
            {
                ...
                m_FuncCode = "030117";
                m_NavTitle = "年度陕西省计划生育家庭情况统计表(农村)";
            }
            else
            {
