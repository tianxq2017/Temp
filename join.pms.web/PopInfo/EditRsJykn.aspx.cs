...
{
    public partial class EditRsJykn : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "\"FILEDS01\",\"FILEDS02\",\"FILEDS03\",\"FILEDS04\",\"FILEDS05\",\"FILEDS06\",\"FILEDS07\",\"FILEDS08\",\"FILEDS09\",\"REPORTDATE\"";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "\"FILEDS01\" ='" + Fileds01 + "',\"FILEDS02\" ='" + Fileds02 + "',\"FILEDS03\" ='" + Fileds03 + "',\"FILEDS04\" ='" + Fileds04 + "',\"FILEDS05\" ='" + Fileds05 + "',\"FILEDS06\" ='" + Fileds06 + "',\"FILEDS07\" ='" + Fileds07 + "',\"FILEDS08\" ='" + Fileds08 + "',\"FILEDS09\" ='" + Fileds09 + "',\"REPORTDATE\" ='" + ReportDate + "' ";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了就业促进局下的<就业困难人员社保补贴信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('就业困难人员社保补贴信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
