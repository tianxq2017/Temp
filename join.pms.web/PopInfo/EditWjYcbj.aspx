<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWjYcbj.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.EditWjYcbj" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>孕产妇保健档案信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列孕产妇保健档案信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">孕产妇姓名：</td>
...
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">新生儿情况：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" TextMode="MultiLine" onkeydown="DoKeyPress(50)" onPaste="CheckPaste(50)" Height="80px" Width="500px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">产后恢复情况：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" TextMode="MultiLine" onkeydown="DoKeyPress(50)" onPaste="CheckPaste(50)" Height="80px" Width="500px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu" width="100">居住地址：</td>
