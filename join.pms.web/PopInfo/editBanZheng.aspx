<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editBanZheng.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editBanZheng" %>
...
<!--提示信息-->
<div class="tsxx">提示信息：每季度第一月20日前提交……</div>
<!-- 页面参数 -->
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">户籍地址：</td>
  <td align="left">
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">子女个数：</td>
  <td align="left">
   <asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="2" Width="100px">0</asp:TextBox>&nbsp;
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">文化程度：</td>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" width="150">办理时间：</td>
  <td align="left">
    <input id="txtFileds08" readonly="readonly" size="29" onclick="PopCalendar(txtFileds08);return false;"  runat="server" />
    <input id="Image1" onclick="PopCalendar(txtFileds08);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
  </td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">营业地址：</td>
  <td align="left"><asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">营业范围：</td>
  <td align="left"><asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">从业人数(本地)：</td>
  <td align="left"><asp:TextBox ID="txtFileds11" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">从业人数(外地)：</td>
  <td align="left"><asp:TextBox ID="txtFileds12" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">是否流动人口：</td>
