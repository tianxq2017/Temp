...
{
    public partial class EditMzShtt : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">起始页</a> &gt;&gt; 民政 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.txtFileds02.Value = PageValidate.GetTrim(sdr["FILEDS02"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds02 = PageValidate.GetTrim(this.txtFileds02.Value);
           ...
           兼职人员党员数,机构代码号信用代码号,党组织,电话
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "FILEDS11,FILEDS12,FILEDS13,FILEDS14,";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "FILEDS11 ='" + Fileds11 + "',FILEDS12 ='" + Fileds12 + "',FILEDS13 ='" + Fileds13 + "',FILEDS14 ='" + Fileds14 + "',";
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了民政下的<社会团体登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('社会团体登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
