<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata030307.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.chatdata030307" %>
...
<table width="880" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
  <tr >
    <td width="80" rowspan="2" align="center" bgcolor="#FFFFCC">跨省流入人口</td>
    <td width="60" align="right" bgcolor="#FFFFCC">男：</td>
    <td><asp:TextBox ID="txtFileds03" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
  <tr class="zhengwen">
    <td width="60" align="right" bgcolor="#FFFFCC">女：</td>
    <td><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
     <tr >
    <td width="80" rowspan="2" align="center" bgcolor="#FFFFCC">省内流入人口</td>
    <td width="60" align="right" bgcolor="#FFFFCC">男：</td>
  ...
  <tr class="zhengwen">
    ...
    <td><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
       ...
       <tr >
    <td width="80" rowspan="2" align="center" bgcolor="#FFFFCC">流出人口</td>
    <td width="60" align="right" bgcolor="#FFFFCC">男：</td>
  ...
  <tr class="zhengwen">
    ...
    <td><asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
       ...
       <tr >
    <td width="80" rowspan="2" align="center" bgcolor="#FFFFCC">跨省流入人口在本地出生</td>
    <td width="60" align="right" bgcolor="#FFFFCC">男：</td>
