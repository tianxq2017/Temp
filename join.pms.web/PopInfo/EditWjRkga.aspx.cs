...
{
    public partial class EditWjRkga : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    UcAreaSel1.SetAreaCode(sdr["AREACODE"].ToString());
                    UcAreaSel1.SetAreaName(sdr["AREANAME"].ToString());
                    // FILEDS01
                    ...
                    string mzyf = PageValidate.GetTrim(sdr["SpecialFlag"].ToString());
                    if (!string.IsNullOrEmpty(mzyf))
                    {
                        foreach (string mzyfCode in mzyf.Split(','))
                        {
                            this.CheckBoxList_MZYF.Items.FindByValue(mzyfCode).Selected = true;
                        }
                    }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem li in CheckBoxList_MZYF.Items)
            {
                if (li.Selected)
                {
                    if (SpecialFlag != null)
                    {
                        SpecialFlag += "," + li.Value;
                    }
                    else
                    {
                        SpecialFlag += li.Value;
            ...
            if (!string.IsNullOrEmpty(SpecialFlag))
...
FILEDS21,FILEDS22,FILEDS23
            ...
            if (String.IsNullOrEmpty(Fileds18))
            {
                strErr += "请输入父亲姓名！\\n";
            }
            ...
            if (!ValidIDCard.VerifyIDCard(Fileds19))
            {
                strErr += "父亲身份证号有误！！\\n";
            }
            ...
            if (!ValidIDCard.VerifyIDCard(Fileds21))
            {
                strErr += "母亲身份证号有误！！\\n";
            }
            if (String.IsNullOrEmpty(Fileds22))
            {
                strErr += "请输入居住状况！\\n";
            }
            if (String.IsNullOrEmpty(Fileds23))
            {
                strErr += "请输入落户地区！\\n";
            }
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "FILEDS21,FILEDS22,FILEDS23,REPORTDATE,AREACODE,AREANAME,SpecialFlag";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "FILEDS21 ='" + Fileds21 + "',FILEDS22 ='" + Fileds22 + "',FILEDS23 ='" + Fileds23 + "',REPORTDATE ='" + ReportDate + "',AREACODE ='" + AREACODE + "',AREANAME ='" + AreaName + "',SpecialFlag =" + SpecialFlag + "";
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14, Fileds15, Fileds16, Fileds17, Fileds18, Fileds19, Fileds20, Fileds21, Fileds22, Fileds23 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫计局下的<全员人口个案基础信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('全员人口个案基础信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
