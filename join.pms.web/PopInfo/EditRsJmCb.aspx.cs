...
{
    public partial class EditRsJmcb : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">起始页</a> &gt;&gt; 居民医保办 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "\"FILEDS01\",\"FILEDS02\",\"FILEDS03\",\"FILEDS04\",\"FILEDS05\",\"FILEDS06\",\"FILEDS07\",\"REPORTDATE\"";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "\"FILEDS01\" ='" + Fileds01 + "',\"FILEDS02\" ='" + Fileds02 + "',\"FILEDS03\" ='" + Fileds03 + "',\"FILEDS04\" ='" + Fileds04 + "',\"FILEDS05\" ='" + Fileds05 + "',\"FILEDS06\" ='" + Fileds06 + "',\"FILEDS07\" ='" + Fileds07 + "',\"REPORTDATE\" ='" + ReportDate + "' ";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了居民医保办下的<参保人员登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('参保人员登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
