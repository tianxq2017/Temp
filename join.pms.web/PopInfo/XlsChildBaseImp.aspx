<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XlsChildBaseImp.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.XlsChildBaseImp" %>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一按步骤操作；数据导入时相同数据日期的同一类数据，不允许存在重复的情况……</div>
<!-- 页面参数 -->
...
<table width="1000" border="0"  cellpadding="3" cellspacing="1"  class="zhengwen">
<tr class="zhengwen">
  <td width="150" align="right" height="25" class="zhengwenjiacu">3、数据日期：</td>
  <td align="left"><input id="txtReportDate" readonly="readonly" size="9" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" />
    (该数据的实际日期,请选择到该数据归属月份之内任意一天（或者准确的日期)即可)
    </td>
</tr>
<tr class="zhengwen">
    <td width="150" align="right" height="30" class="zhengwenjiacu">4、执行导入：</td>
