<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editBirthReg.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editBirthReg" %>
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#FFFFCC">新生儿姓名：</td>
...
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100" bgcolor="#FFFFCC">受理时间：</td>
    <td align="left" width="*"><input id="txtFileds04" readonly="readonly" size="29" onclick="PopCalendar(txtFileds04);return false;"  runat="server" />
    <input id="Image2" onclick="PopCalendar(txtFileds04);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" /></td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
...
<tr><td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">身份证号：</td>
  <td align="left"><asp:TextBox ID="txtFileds08" runat="server" EnableViewState="False" MaxLength="18" Width="200px"/></td>
</tr>
</table>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1" class="zhengwen">
<tr>
    <td width="100" align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">住址省市县(区)名称：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
<tr><td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">住址派出所名称：</td>
  <td align="left"><asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
<tr><td align="right" bgcolor="#FFFFCC" class="zhengwenjiacu">住址居(村)委会名称：</td>
  <td align="left"><asp:TextBox ID="txtFileds11" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
</table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<br/>
