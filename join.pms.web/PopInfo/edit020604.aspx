<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020604.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020604" %>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td width="100" height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">姓名：</td>
...
<tr class="zhengwen">
 ...
 <tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">输出地：</td>
    <td align="left"><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
 </tr>
  <tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">备注：</td>
