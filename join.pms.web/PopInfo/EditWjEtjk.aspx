<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWjEtjk.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.EditWjEtjk" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>儿童健康档案信息</title>
...
<tr class="zhengwen">
    ...
    <td align="left" width="*"><asp:TextBox ID="txtFileds03" runat="server" EnableViewState="False" MaxLength="25" Width="200px" onblur="showBirthday('txtFileds03','txtFileds04')"/></td>
</tr>
<tr class="zhengwen">
