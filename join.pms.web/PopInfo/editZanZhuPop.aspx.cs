...
{
    public partial class editZanZhuPop : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //this.txtFileds10.Attributes.Add("onKeyUp", "ShowDivsBy(this.value)");
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            // <!--暂住证编号,公民身份号码,姓名,出生日期,性别,暂住地址,相片,访查预警,证件状态-->
	  ...
	  <Fields>Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds11,Fileds12,Fileds13,Fileds14,ReportDate,AuditFlagCN</Fields>*/
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了公安局下的<办理暂住证人口信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('办理暂住证人口信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
