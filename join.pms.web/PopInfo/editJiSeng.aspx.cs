...
{
    public partial class editJiSeng : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">管理首页</a> &gt;&gt; 县计生服务站 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.UcAreaSel16.SetAreaName(PageValidate.GetTrim(sdr["Fileds16"].ToString()));
                    this.UcAreaSel17.SetAreaName(PageValidate.GetTrim(sdr["Fileds17"].ToString()));
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds16 = PageValidate.GetTrim(this.UcAreaSel16.GetAreaName());
            string Fileds17 = PageValidate.GetTrim(this.UcAreaSel17.GetAreaName());
            ...
            if (String.IsNullOrEmpty(Fileds01)) { strErr += "请输入姓名！\\n"; }
            if (String.IsNullOrEmpty(Fileds02)) { strErr += "请输入身份证号！\\n"; }
            if (!ValidIDCard.VerifyIDCard(Fileds02)) { strErr += "身份证号码有误！\\n"; }
            if (String.IsNullOrEmpty(Fileds03)) { strErr += "请选择出生日期！\\n"; }
            if (String.IsNullOrEmpty(Fileds04)) { strErr += "请输入管理类型！\\n"; }
            if (String.IsNullOrEmpty(Fileds05)) { strErr += "请输入本次免费项目！\\n"; }
            if (String.IsNullOrEmpty(Fileds06)) { strErr += "请输入免费结算标准金额！\\n"; }
            else { if (!PageValidate.IsNumber(Fileds06)) strErr += "免费结算标准金额格式错误,必须为数字！\\n"; }
            if (String.IsNullOrEmpty(Fileds07)) { strErr += "请选择有效时间！\\n"; }
            if (String.IsNullOrEmpty(Fileds08)) { strErr += "请输入审核人！\\n"; }
            if (String.IsNullOrEmpty(Fileds09)) { strErr += "请输入服务单位！\\n"; }
            if (String.IsNullOrEmpty(Fileds10)) { strErr += "请输入回执人！\\n"; }
            if (String.IsNullOrEmpty(Fileds11)) { strErr += "请输入服务时间！\\n"; }
            if (String.IsNullOrEmpty(Fileds12)) { strErr += "请输入服务医生！\\n"; }
            if (String.IsNullOrEmpty(Fileds13)) { strErr += "请输入服务机构！\\n"; }
            if (String.IsNullOrEmpty(Fileds14)) { strErr += "请输入单位负责人！\\n"; }
            if (String.IsNullOrEmpty(Fileds15)) { strErr += "请选择现居住地！\\n"; }
            if (String.IsNullOrEmpty(Fileds16)) { strErr += "请选择户籍所在地！\\n"; }
            if (String.IsNullOrEmpty(Fileds17)) { strErr += "请选择所属地区！\\n"; }
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds10,";
                 m_SqlParams += "Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,Fileds16,Fileds17,Fileds18,ReportDate,AreaCode,AreaName ";
                m_SqlParams += ") VALUES(";
                m_SqlParams += "" + m_UserID + ",'" + m_FuncCode + "',";
                m_SqlParams += "'" + Fileds01 + "','" + Fileds02 + "','" + Fileds03 + "','" + Fileds04 + "','" + Fileds05 + "','" + Fileds06 + "',";
                m_SqlParams += "'" + Fileds07 + "','" + Fileds07 + "','" + Fileds08 + "','" + Fileds09 + "','" + Fileds10 + "','" + Fileds11 + "',";
                m_SqlParams += "'" + Fileds12 + "','" + Fileds13 + "','" + Fileds15 + "','" + Fileds16 + "','" + Fileds17 + "','" + Fileds18 + "','" + ReportDate + "','" + AreaCode + "','" + AreaName + "'";
                m_SqlParams += ")";
            }
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds16 ='" + Fileds16 + "',Fileds17 ='" + Fileds17 + "',Fileds18 ='" + Fileds18 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "' ";
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了县计生服务站下的<计生机构落实节育情况登记>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('计生机构落实节育情况登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
