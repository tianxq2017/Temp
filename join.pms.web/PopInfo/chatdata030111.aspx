<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata030111.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.chatdata030111" %>
...
<!-- 编辑区  -->
<br/>
<table width="1000" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
...
<table width="1000" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<table width="1000" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
  <tr>
    <td align="right" bgcolor="#FFFFCC" colspan="2">年份：</td>
    <td>
    ...
    <td><uc1:ucDataAreaSel ID="UcDataAreaSel2" runat="server" /></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#FFFFCC" colspan="2">期初常住人口数：</td>
    <td><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
    <td align="right" bgcolor="#FFFFCC" rowspan="9">本期出生人数</td>
    <td align="right" bgcolor="#FFFFCC" rowspan="3">一孩出生</td>
  ...
  <tr>
    <td align="right" bgcolor="#FFFFCC" colspan="2">期末常住人口数：</td>
  ...
  <tr>
    <td align="right" bgcolor="#FFFFCC" colspan="2">往年出生未报人数：</td>
  ...
  <tr>
    <td align="right" bgcolor="#FFFFCC">19岁及 以下人数：</td>
  ...
  <tr>
    <td align="right" bgcolor="#FFFFCC">23岁及 以上人数：</td>
  ...
  <tr>
    <td align="right" bgcolor="#FFFFCC" colspan="2">死亡人数：</td>
  ...
  <tr>
    ...
    <td align="right" bgcolor="#FFFFCC" colspan="3">填表人:</td>
