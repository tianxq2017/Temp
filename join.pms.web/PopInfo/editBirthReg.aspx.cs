...
{
    public partial class editBirthReg : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">管理首页</a> &gt;&gt; 公安局 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    // SELECT AreaCode,AreaName FROM [AreaDetailCN] WHERE  AreaCode LIKE '610927%000' AND AreaCode!='610526000000' ORDER BY AreaCode
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!ValidIDCard.VerifyIDCard(Fileds06))
            {
                strErr += "父亲身份证号码有误！！\\n";
            }
            ...
            if (!ValidIDCard.VerifyIDCard(Fileds08))
            {
                strErr += "母亲身份证号码有误！！\\n";
            }
            if (String.IsNullOrEmpty(Fileds09))
            {
                strErr += "请输入住址省市县(区)名称！\\n";
            }
            ...
            // ==== start == 操作核心基础表 2012/11/12 By Ysl ===
            //AreWeb.CertificateInOne.Biz.PIS_Persons pis = new AreWeb.CertificateInOne.Biz.PIS_Persons();
            //pis.P_ID = "";
            //pis.P_Name = Fileds02;
            //pis.P_Sex = Fileds03;
            //pis.P_CardID = Fileds05;
            //pis.P_Addres = Fileds04;
            //pis.P_Nation="";
            //pis.P_Edu="";
            //pis.P_Job="";
            //pis.P_Marry="";
            //pis.P_Tel="";
            //pis.P_TransType="";
            //pis.P_TransDate=DateTime.Now.ToString("yyyy/MM/dd");
            //pis.P_FatherName = Fileds07;
            //pis.P_FatherCID = Fileds10;
            //pis.P_MotherName = Fileds11;
            //pis.P_MotherCID = Fileds14;
            //if (pis.IsPersonExist()) { pis.Update(m_FuncCode); }
            //else {  pis.Insert(m_FuncCode); }
            //// ==== end ==
            /*
             <Titles>上户日期,姓名,性别,家庭地址,身份证号,出生日期,父亲姓名,工作单位,家庭地址,身份证号,母亲姓名,工作单位,家庭地址,身份证号,数据日期,状态</Titles>
	     <Fields>Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds10,Fileds11,Fileds12,Fileds13,Fileds14,ReportDate,AuditFlagCN</Fields>
             */
            // P_ID,P_Name,P_Sex,P_CardID,P_Addres,P_Nation,P_Edu,P_Job,P_Marry,P_FatherName,P_FatherCID,P_MotherName,P_MotherCID,Attribs,CreateDate,OprateDate
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds11,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds11 ='" + Fileds11 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "' ";
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了公安局下的<新生儿落户信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('新生儿落户信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
