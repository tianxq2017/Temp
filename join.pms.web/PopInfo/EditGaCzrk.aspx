<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGaCzrk.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditGaCzrk" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>公安常驻人口基础信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列常住人口个案基础信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<tr class="zhengwen">
    <td height="25" width="100" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">状态：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>   
</tr>
<tr class="zhengwen">
    <td height="25" width="100" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">户号：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>   
</tr>
<tr class="zhengwen">
    <td height="25" width="100" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">与户主关系：</td>
...
<tr class="zhengwen">
    ...
    <td align="left" width="*"><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="25" Width="200px" onblur="showBirthday('txtFileds05','txtFileds07')"/></td>   
</tr>
<tr class="zhengwen">
...
<tr class="zhengwen">
    ...
    <td align="left" width="*">
    <input id="txtFileds07" readonly="readonly" size="29" onclick="JTC.setday({format:'yyyy-MM-dd', readOnly:true})" runat="server" />
    </td>    
</tr>
<tr class="zhengwen">  
  <td align="right" bgcolor="#ccffff" class="zhengwenjiacu">民族：</td>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" width="100" height="25" class="zhengwenjiacu">派出所：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" MaxLength="40" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu">居村委会：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" MaxLength="40" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu">街路巷：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds11" runat="server" EnableViewState="False" MaxLength="40" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" bgcolor="#CCFFFF" height="25" class="zhengwenjiacu">省市县区：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds12" runat="server" EnableViewState="False" MaxLength="40" Width="200px"/></td>
</tr>
