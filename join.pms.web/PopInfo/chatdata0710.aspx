<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatdata0710.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.chatdata0710" %>
...
<table width="880" border="0" cellspacing="3" cellpadding="1" class="zhengwen">
  ...
  <tr class="zhengwen">
    <td rowspan="2" align="center" bgcolor="#FFFFCC" style="width: 70px">放弃生<br/>育二孩</td>
    <td align="right" bgcolor="#FFFFCC" style="width: 70px">新增：</td>
    <td ><asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
  <tr class="zhengwen">
    <td align="right" bgcolor="#FFFFCC" style="width: 70px">累计人数：</td>
    <td ><asp:TextBox ID="txtFileds03" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
  <tr>
    <td rowspan="3" align="center" bgcolor="#FFFFCC" style="width: 70px">国扶</td>
    <td align="right" bgcolor="#FFFFCC" style="width: 70px; height: 25px">新增：</td>
    <td ><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#FFFFCC" style="width: 70px">退出：</td>
    <td ><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>  
    <tr>
    <td align="right" bgcolor="#FFFFCC" style="width: 70px">全部人数：</td>
    <td ><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
  </tr>
    <tr>
    <td rowspan="3" align="center" bgcolor="#FFFFCC" style="width: 70px">独女</td>
    <td align="right" bgcolor="#FFFFCC" style="width: 70px; height: 25px">新增：</td>
