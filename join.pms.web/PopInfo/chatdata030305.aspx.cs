...
{
    public partial class chatdata030305 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.ddlFileds02.SelectedValue = PageValidate.GetTrim(sdr["Fileds02"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(Fileds03) || !PageValidate.IsNumber(Fileds03)) strErr += "应服务数不能为空且必须为数字格式！\\n";
            if (String.IsNullOrEmpty(Fileds04) || !PageValidate.IsNumber(Fileds04)) strErr += "已服务数不能为空且必须为数字格式！\\n";
            //if (String.IsNullOrEmpty(Fileds06) ) strErr += "填报人不能为空！\\n";
            //if (String.IsNullOrEmpty(Fileds07) ) strErr += "负责人不能为空！\\n";

            Fileds05 = (float.Parse(Fileds04) / float.Parse(Fileds03)) * 100;//出生率
            if (strErr != "")
            {
            ...
            if (m_ActionName == "add")
            {
                ...
                DataTable table = DbHelperSQL.Query("select * from PIS_BaseInfo where FuncNo = '030305' and ReportDate = '" + ReportDate + "' and AreaCode = '" + AreaCode + "'").Tables[0];
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,";
                m_SqlParams += "Fileds06,Fileds07,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
                m_SqlParams += "" + m_UserID + ",'" + m_FuncCode + "',";
                m_SqlParams += "'" + Fileds01 + "','" + Fileds02 + "','" + Fileds03 + "','" + Fileds04 + "','" + Fileds05.ToString("F1") + "','" + Fileds06 + "','" + Fileds07 + "',";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds01 ='" + Fileds01 + "',Fileds02 ='" + Fileds02 + "',Fileds03 ='" + Fileds03 + "',Fileds04 ='" + Fileds04 + "',Fileds05 ='" + Fileds05.ToString("F1") + "',Fileds06 ='" + Fileds06 + "',Fileds07 ='" + Fileds07 + "',";
            ...
            try
            {
                ...
                //{
                //    // 分析修改的字段、记录修改日志
                //    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05.ToString("F2"), Fileds06, Fileds07 };
                ...
                //    {
                //        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了基础数据填报下的<人口计生“三查”统计分析表>：" + returnVal;
                ...
                //}
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('人口计生“三查”统计分析表操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
