...
{
    public partial class EditWjNcjs : System.Web.UI.Page
    {
...
FILEDS06,FILEDS07,FILEDS08,FILEDS09,FILEDS10,
            ...
            if (!PageValidate.IsNumber(Fileds07))
            {
                strErr += "请输入数字格式的曾生育男孩！\\n";
            }
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫计局下的<农村计生家庭奖扶证信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('农村计生家庭奖扶证信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
