<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EditRsLdda.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditRsLdda" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>人社局-入网档案管理信息</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <!--提示信息-->
        <div class="tsxx">
            提示信息：请逐一填写下列入网档案管理信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
        <!-- 页面参数 -->
                                    ...
                                    <table width="880" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <tr class="zhengwen">
                                            ...
                                            <td align="left" colspan="3">
                                                <asp:TextBox ID="txtFileds03" runat="server" EnableViewState="False" /></td>
                                        </tr>
                                        <tr class="zhengwen">
                                            <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">
                                                联系电话：</td>
