...
{
    public partial class chatdata030110 : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.UcDataAreaSel2.SetAreaCode(PageValidate.GetTrim(sdr["Fileds02"].ToString()));
                    this.UcDataAreaSel2.SetAreaName(PageValidate.GetTrim(sdr["Fileds03"].ToString()));
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds02 = PageValidate.GetTrim(this.UcDataAreaSel2.GetAreaCode());
            string Fileds03 = PageValidate.GetTrim(this.UcDataAreaSel2.GetAreaName());
            ...
            if (String.IsNullOrEmpty(AreaCode) || String.IsNullOrEmpty(AreaName)) { strErr += "请选择请选择数据单位！\\n"; }
            if (String.IsNullOrEmpty(Fileds01)) { strErr += "请选择年份！\\n"; }
            if (String.IsNullOrEmpty(Fileds02) || String.IsNullOrEmpty(Fileds03)) { strErr += "请选择请选择地区！\\n"; }
            if (String.IsNullOrEmpty(Fileds04)) { strErr += "请输入总数！\\n"; }
            if (String.IsNullOrEmpty(Fileds05)) { strErr += "请输入育龄妇女人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds06)) { strErr += "请输入其中独男户数！\\n"; }
            if (String.IsNullOrEmpty(Fileds07)) { strErr += "请输入合计！\\n"; }
            if (String.IsNullOrEmpty(Fileds08)) { strErr += "请输入小计！\\n"; }
            if (String.IsNullOrEmpty(Fileds09)) { strErr += "请输入零孩妇女！\\n"; }
            if (String.IsNullOrEmpty(Fileds10)) { strErr += "请输入其中独男户数！\\n"; }
            if (String.IsNullOrEmpty(Fileds11)) { strErr += "请输入二孩总数！\\n"; }
            if (String.IsNullOrEmpty(Fileds12)) { strErr += "请输入皮埋人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds13)) { strErr += "请输入其中双女户数！\\n"; }
            if (String.IsNullOrEmpty(Fileds14)) { strErr += "请输入药具人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds15)) { strErr += "请输入上环数小计！\\n"; }
            if (String.IsNullOrEmpty(Fileds16)) { strErr += "请输入多孩妇女总数！\\n"; }
            if (String.IsNullOrEmpty(Fileds17)) { strErr += "请输入其中双女户数！\\n"; }
            if (String.IsNullOrEmpty(Fileds18)) { strErr += "请输入绝育人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds19)) { strErr += "请输入上环人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds20)) { strErr += "请输入上环人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds21)) { strErr += "请输入皮埋人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds22)) { strErr += "请输入皮埋人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds23)) { strErr += "请输入药具人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds24)) { strErr += "请输入药具人数！\\n"; }
            if (String.IsNullOrEmpty(Fileds25)) { strErr += "请输入合    计！\\n"; }
            if (String.IsNullOrEmpty(Fileds26)) { strErr += "请输入统计负责人！\\n"; }
            if (String.IsNullOrEmpty(Fileds27)) { strErr += "请输入填表人！\\n"; }
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds10,Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,Fileds16,Fileds17,Fileds18,Fileds19,Fileds20,Fileds21,Fileds22,Fileds23,Fileds24,Fileds25,Fileds26,Fileds27,";
                ...
                m_SqlParams += "'" + Fileds19 + "','" + Fileds20 + "','" + Fileds21 + "','" + Fileds22 + "','" + Fileds23 + "','" + Fileds24 + "','" + Fileds25 + "','" + Fileds26 + "','" + Fileds27 + "',";
                m_SqlParams += "'" + ReportDate + "','" + AreaCode + "','" + AreaName + "'";
                m_SqlParams += ")";
            }
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds19 ='" + Fileds19 + "',Fileds20 ='" + Fileds20 + "',Fileds21 ='" + Fileds21 + "',Fileds22 ='" + Fileds22 + "',Fileds23 ='" + Fileds23 + "',";
                m_SqlParams += "Fileds24 ='" + Fileds24 + "',Fileds25 ='" + Fileds25 + "',Fileds26 ='" + Fileds26 + "',Fileds27 ='" + Fileds27 + "',";
            ...
            {
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('（半）年已婚育龄妇女孩次、节育情况(农村）数据操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
        ...
        private void ValidateParams()
        {
            ...
            if (!string.IsNullOrEmpty(m_SourceUrl) && !string.IsNullOrEmpty(m_ActionName))
            {
                ...
                m_NavTitle = "（半）年已婚育龄妇女孩次、节育情况(农村）";
            }
            else
            {
                Response.Write("非法访问，操作被终止！");
