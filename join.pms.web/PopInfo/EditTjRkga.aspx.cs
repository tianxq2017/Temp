...
{
    public partial class EditTjRkga : System.Web.UI.Page
    {
        ...
        private void SetOpratetionAction(string oprateName)
        {
            ...
            this.LiteralNav.Text = "<a href=\"/MainDesk.aspx\">起始页</a> &gt;&gt; 统计局 &gt;&gt; <a href=\"" + m_TargetUrl + "\">" + oprateName + "</a> &gt;&gt; " + funcName + "：";
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                //判断年度是否重复
                string rtv = CommPage.GetSingleVal("select count(0) from PIS_BASEINFO where FuncNo='01010601' and FILEDS01='" + Fileds01 + "'");
                if (rtv == "0")
                {
                    m_SqlParams = "INSERT INTO \"PIS_BASEINFO\"(";
                    m_SqlParams += "\"OPRATEUSERID\",\"FUNCNO\",";
                    m_SqlParams += "\"FILEDS01\",\"FILEDS02\",\"FILEDS03\",\"FILEDS04\",\"FILEDS05\",\"FILEDS06\",\"FILEDS07\",\"FILEDS08\",\"FILEDS09\",\"FILEDS10\",\"FILEDS11\",\"FILEDS12\",\"FILEDS13\",\"FILEDS14\",\"FILEDS15\",\"REPORTDATE\"";
                    m_SqlParams += ") VALUES(";
                ...
                {
                    MessageBox.Show(this, "该年度数据已经提交，不能重复提交！");
                    return;
                }
            }
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了统计局下的<国民经济和社会发展主要指标信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('国民经济和社会发展主要指标信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
