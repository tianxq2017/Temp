...
{
    public partial class editKuanFa : System.Web.UI.Page
    {
        ...
        private void ValidateParams()
        {
            ...
            if (!string.IsNullOrEmpty(m_SourceUrl) && !string.IsNullOrEmpty(m_ActionName))
            {
                ...
                m_NavTitle = "未升入高中、大学计生家庭子女技能培训登记";
            }
            else
            {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds04 = PageValidate.GetTrim(this.UcAreaSelXian04.GetSelAreaName());
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了人社局下的<未升学计生家庭子女贴息贷款>：" + returnVal;
