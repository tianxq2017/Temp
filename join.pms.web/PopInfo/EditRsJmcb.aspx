<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRsJmcb.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditRsJmcb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>人社局-参保人员登记信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列参保人员登记信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
