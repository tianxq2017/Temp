<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020701.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020701" %>
...
<!-- 编辑区  -->
<br/>
<!--单位,总户数,总人口,男性人口,女性人口,非农人口,农业人口,城镇居民人均可支配收入,农民人均纯收入-->
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" width="100">总户数：</td>
  <td align="left"><asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">总人口：</td>
