...
{
    public partial class chatdata030115 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(ReportDate)) strErr += "请选择报出日期！\\n";
            ...
            if (String.IsNullOrEmpty(Fileds21)) { strErr += "请输入统计负责人！\\n"; }
            if (String.IsNullOrEmpty(Fileds22)) { strErr += "请输入填表人！\\n"; }
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds10,Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,Fileds16,Fileds17,Fileds18,Fileds19,Fileds20,Fileds21,Fileds22,";
            ...
            else if (m_ActionName == "edit")
            {
                ...
                m_SqlParams += "Fileds12 ='" + Fileds12 + "',Fileds13 ='" + Fileds13 + "',Fileds14 ='" + Fileds14 + "',Fileds15 ='" + Fileds15 + "',Fileds16 ='" + Fileds16 + "',Fileds17 ='" + Fileds17 + "',Fileds18 ='" + Fileds18 + "',Fileds19 ='" + Fileds19 + "',Fileds20 ='" + Fileds20 + "',Fileds21 ='" + Fileds21 + "',Fileds22 ='" + Fileds22 + "',";
            ...
            {
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('年度已婚育龄妇女生殖健康服务情况数据操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
