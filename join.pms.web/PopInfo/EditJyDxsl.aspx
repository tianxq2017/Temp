<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditJyDxsl.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.EditJyDxsl" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>教育大学生录取信息</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列大学生录取信息后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">准考证号：</td>
...
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">院校代码：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds04" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">院校名称：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">专业代码：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">专业名称：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds07" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">科类代码：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds08" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">录取时间：</td>
    <td align="left" width="*"><input id="txtFileds09" readonly="readonly" size="29" onclick="PopCalendar(txtFileds09);return false;"  runat="server" />
    <input id="Image5" onclick="PopCalendar(txtFileds09);return false;" tabIndex="1" type="image" src="/images/calendar.gif" align="absMiddle"></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">批次代码：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds10" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">批次名称：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds11" runat="server" EnableViewState="False" MaxLength="25" Width="200px" /></td>
</tr>
<!--
准考证号,姓名,身份证号,院校代码,院校名称,
FILEDS01,FILEDS02,FILEDS03,FILEDS04,FILEDS05,
专业代码,专业名称,科类代码,录取时间,批次代码,
FILEDS06,FILEDS07,FILEDS08,FILEDS09,FILEDS10,
批次名称,学制
FILEDS11,FILEDS12
-->
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">学制：</td>
