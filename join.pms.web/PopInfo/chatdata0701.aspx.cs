...
;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Fileds15 = (float.Parse(Fileds02.ToString()) / float.Parse(Fileds01))*1000 ;//出生率
            Fileds16 = (float.Parse(Fileds14.ToString()) / float.Parse(Fileds01))*1000;//死亡率
            ...
            try
            {
                ...
                //    {
                //        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了人口计生局下的<人口计划情况汇总分析基础数据>：" + returnVal;
