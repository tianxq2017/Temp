...
{
    public partial class editZaiJiuYe : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.DDLFileds03.SelectedValue = PageValidate.GetTrim(sdr["Fileds03"].ToString());
                    this.DDLFileds04.SelectedValue = PageValidate.GetTrim(sdr["Fileds04"].ToString());
                    this.txtFileds05.Value =PageValidate.GetTrim( sdr["Fileds05"].ToString());
                    this.DDLFileds06.SelectedValue =PageValidate.GetTrim(sdr["Fileds06"].ToString());
                    this.DDLFileds07.SelectedValue = PageValidate.GetTrim(sdr["Fileds07"].ToString());
                    this.DDLFileds08.SelectedValue = PageValidate.GetTrim(sdr["Fileds08"].ToString());
                    ...
                    this.DDLFileds11.SelectedValue = PageValidate.GetTrim(sdr["Fileds11"].ToString());
                    ...
                    this.DDLFileds14.SelectedValue = PageValidate.GetTrim(sdr["Fileds14"].ToString());
                    this.DDLFileds15.SelectedValue = PageValidate.GetTrim(sdr["Fileds15"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds05 = PageValidate.GetTrim(this.txtFileds05.Value);
            string Fileds06 = PageValidate.GetTrim(this.DDLFileds06.SelectedValue);
            string Fileds07 = PageValidate.GetTrim(this.DDLFileds07.SelectedValue);
            string Fileds08 = PageValidate.GetTrim(this.DDLFileds08.SelectedValue);
            ...
            string Fileds11 = PageValidate.GetTrim(this.DDLFileds11.SelectedValue);
            ...
            string Fileds14 = PageValidate.GetTrim(this.DDLFileds14.SelectedValue);
            string Fileds15 = PageValidate.GetTrim(this.DDLFileds15.SelectedValue);
            ...
            if (m_ActionName == "add")
            {
                ...
                m_SqlParams += "Fileds01,Fileds02,Fileds03,Fileds04,Fileds05,Fileds06,Fileds07,Fileds08,Fileds09,Fileds10,Fileds11,Fileds12,Fileds13,Fileds14,Fileds15,ReportDate,AreaCode,AreaName";
                m_SqlParams += ") VALUES(";
            ...
            else if (m_ActionName == "edit")
            {
               ...
               m_SqlParams += "Fileds11 ='" + Fileds11 + "',Fileds12 ='" + Fileds12 + "',Fileds13 ='" + Fileds13 + "',Fileds14 ='" + Fileds14 + "',Fileds15 ='" + Fileds15 + "',ReportDate ='" + ReportDate + "',AreaCode ='" + AreaCode + "',AreaName ='" + AreaName + "'";
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14, Fileds15 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了人社局下的<计生家庭下岗职工再就业信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('计生家庭下岗职工再就业信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
