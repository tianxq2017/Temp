<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWjFqeh.aspx.cs" Inherits="AreWeb.OnlineCertificate.PopInfo.EditWjFqeh" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>卫计放弃二孩生育花名册</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列放弃二孩生育花名册后；点击“提交”按钮（次月5日以前将上月情况提交）……</div>
<!-- 页面参数 -->
...
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">发证日期：</td>
...
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">符合指标类型：</td>
    <td align="left" width="*"><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="25" Width="200px" /></td>
</tr>
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="100">奖金发放情况：</td>
