<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editBaoXian.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editBaoXian" %>
...
<!--提示信息-->
<div class="tsxx">提示信息：请逐一填写下列信息后；点击“提交”按钮（每年11月20日前提交）……</div>
<!-- 页面参数 -->
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="150">男方姓名：</td>
...
<tr class="zhengwen">
  ...
  <td align="left"><uc1:ucAreaSelXian ID="UcAreaSelXian03" runat="server" /></td>
</tr></table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu" width="150">女方姓名：</td>
...
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu">家庭住址：</td>
  <td align="left"><uc1:ucAreaSelXian ID="UcAreaSelXian06" runat="server" /></td>
</tr></table>
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" width="150">缴纳保险日期：</td>
  <td align="left">
    <input id="txtFileds07" readonly="readonly" size="29" onclick="PopCalendar(txtFileds07);return false;"  runat="server" />
    <input id="Image1" onclick="PopCalendar(txtFileds07);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
  </td>
</tr>
<tr class="zhengwen">
