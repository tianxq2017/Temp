...
{
    public partial class editAdoption : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.UcAreaSel12.SetAreaName(PageValidate.GetTrim(sdr["Fileds12"].ToString()));
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds12 = PageValidate.GetTrim(this.UcAreaSel12.GetAreaName());
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了民政局下的<收养子女信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('收养子女信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
