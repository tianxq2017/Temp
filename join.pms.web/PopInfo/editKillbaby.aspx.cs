...
{
    public partial class editKillbaby : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.DropDownList10.Text = PageValidate.GetTrim(sdr["Fileds10"].ToString());
                    this.DropDownList11.Text = PageValidate.GetTrim(sdr["Fileds11"].ToString());
        ...
        private void AuditInfo(string objID)
        {
            try
            {
                ...
                {
                    Response.Write(" <script>alert('操作失败：您选择的信息包含不是同一类信息！') ;window.location.href='" + m_TargetUrl + "'</script>");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds10 = PageValidate.GetTrim(this.DropDownList10.Text);
            string Fileds11 = PageValidate.GetTrim(this.DropDownList11.Text);
            ...
            try
            {
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了终止中期妊娠手术登记表：" + returnVal;
