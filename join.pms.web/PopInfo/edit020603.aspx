<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020603.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020603" %>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td width="150" height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">身份证号码：</td>
    <td align="left"><asp:TextBox ID="txtFileds01" runat="server" EnableViewState="False" MaxLength="18" Width="200px"/></td>
</tr>
<tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">姓名：</td>
...
<tr class="zhengwen">
    ...
    <input id="Image2" onclick="PopCalendar(txtFileds03);return false;" tabindex="1" type="image" src="/images/calendar.gif" align="absmiddle" />
    </td>
 </tr>
 <tr class="zhengwen">
...
<tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">人员状态：</td>
...
<tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">收缴方式：</td>
