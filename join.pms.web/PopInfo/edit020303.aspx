<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit020303.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.edit020303" %>
...
<table width="880" border="0"  cellpadding="3" cellspacing="1">
<tr class="zhengwen">
    <td width="150" height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">户主姓名：</td>
...
<tr class="zhengwen">
    ...
    <td align="left"><asp:TextBox ID="txtFileds02" runat="server" EnableViewState="False" MaxLength="2" Width="200px"/></td>
 </tr>
 <tr class="zhengwen">
...
<tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">家庭住址：</td>
    <td align="left"><uc1:ucAreaSel ID="UcAreaSel04" runat="server" /></td>
 </tr>
 <tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">所在社区：</td>
    <td align="left"><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="25" Width="200px"/></td>
 </tr>
 <tr class="zhengwen">
    <td height="25" align="right" bgcolor="#CCFFFF" class="zhengwenjiacu">享受人口：</td>
    <td align="left"><asp:TextBox ID="txtFileds06" runat="server" EnableViewState="False" MaxLength="2" Width="200px"/></td>
 </tr>
</table><!--户主姓名,性别,身份证号,家庭住址,所在社区,享受人口-->
<table width="880" border="0"  cellpadding="0" cellspacing="0"><tr><td height="4" background="/images/xuxian.gif" ></td></tr></table>
<br/>
<!-- 操作按钮 m_TargetUrl -->
