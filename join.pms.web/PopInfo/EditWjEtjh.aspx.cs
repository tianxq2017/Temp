...
{
    public partial class EditWjEtjh : System.Web.UI.Page
    {
        ...
        private void ShowModInfo(string objID)
        {
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    this.DDLFileds07.Text = PageValidate.GetTrim(sdr["FILEDS07"].ToString());
                    ...
                    this.DDLFileds12.Text = PageValidate.GetTrim(sdr["FILEDS12"].ToString());
                    ...
                    this.txtFileds15.Value = PageValidate.GetTrim(sdr["FILEDS15"].ToString());
                    ...
                    this.DDLFileds19.Text = PageValidate.GetTrim(sdr["FILEDS19"].ToString());
                    ...
                    this.txtFileds25.Value = PageValidate.GetTrim(sdr["FILEDS25"].ToString());
                    this.txtFileds26.Text = PageValidate.GetTrim(sdr["FILEDS26"].ToString());
                    this.txtFileds27.Value = PageValidate.GetTrim(sdr["FILEDS27"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string Fileds04 = PageValidate.GetTrim(this.DDLFileds04.Text);
            string Fileds05 = PageValidate.GetTrim(this.txtFileds05.Text);
            string Fileds06 = PageValidate.GetTrim(this.txtFileds06.Text);
            string Fileds07 = PageValidate.GetTrim(this.DDLFileds07.Text);
            ...
            string Fileds12 = PageValidate.GetTrim(this.DDLFileds12.Text);
            string Fileds13 = PageValidate.GetTrim(this.txtFileds13.Text);
            string Fileds14 = PageValidate.GetTrim(this.txtFileds14.Text);
            string Fileds15 = PageValidate.GetTrim(this.txtFileds15.Value);
            ...
            string Fileds19 = PageValidate.GetTrim(this.DDLFileds19.Text);
            ...
            string Fileds25 = PageValidate.GetTrim(this.txtFileds25.Value);
            string Fileds26 = PageValidate.GetTrim(this.txtFileds26.Text);
            string Fileds27 = PageValidate.GetTrim(this.txtFileds27.Value);
...
Fileds26,Fileds27
            ...
            if (String.IsNullOrEmpty(Fileds20))
            {
                strErr += "请输入户籍地地址！\\n";
            }
            if (String.IsNullOrEmpty(Fileds21))
            {
                strErr += "请输入现住地地址！\\n";
            }
            ...
            {
                //判断儿童编码是否重复
                string rtv=CommPage.GetSingleVal("select count(0) from PIS_BASEINFO where FuncNo='01010112' and FILEDS01='" + Fileds01 + "'");
                if (rtv == "0")
                {
                    ...
                    m_SqlParams += "FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,";
                ...
                {
                    MessageBox.Show(this, "儿童编码已存在，不能提交！");
                    return;
                }
            }
            ...
            {
                //判断儿童编码是否重复
                string rtv1 = CommPage.GetSingleVal("select CommID from PIS_BASEINFO where FuncNo='01010113' and FILEDS01='" + Fileds01 + "'");
                if (rtv1 == m_ObjID)
                {
                    ...
                    m_SqlParams += "FILEDS26 ='" + Fileds26 + "',FILEDS27 ='" + Fileds27 + "'";
                    m_SqlParams += " WHERE COMMID=" + m_ObjID;
                }
                else
                {
                    string rtv2=CommPage.GetSingleVal("select count(0) from PIS_BASEINFO where FuncNo='01010113' and FILEDS01='" + Fileds01 + "'");
                    if (rtv2 == "0")
                    {
                        m_SqlParams = "UPDATE PIS_BASEINFO SET ";
                        m_SqlParams += "FILEDS01 ='" + Fileds01 + "',FILEDS02 ='" + Fileds02 + "',FILEDS03 ='" + Fileds03 + "',FILEDS04 ='" + Fileds04 + "',FILEDS05 ='" + Fileds05 + "',";
...
,FILEDS21,FILEDS22,FILEDS23,FILEDS24,FILEDS25,FILEDS26,FILEDS27,FILEDS28,FILEDS29,FILEDS30,FILEDS31,FILEDS32,FILEDS33,FILEDS34,FILEDS35 
            ...
            try
            {
                ...
                {
                    // 分析修改的字段、记录修改日志
                    string[] updateVal = { Fileds01, Fileds02, Fileds03, Fileds04, Fileds05, Fileds06, Fileds07, Fileds08, Fileds09, Fileds10, Fileds11, Fileds12, Fileds13, Fileds14, Fileds15, Fileds16, Fileds17, Fileds18, Fileds19, Fileds20, Fileds21, Fileds22, Fileds23, Fileds24, Fileds25, Fileds26, Fileds27 };
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了卫计局下的<儿童计划免疫登记信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('儿童计划免疫登记信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
