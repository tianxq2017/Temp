<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editMoveIn.aspx.cs" Inherits="AreWeb.CertificateInOne.PopInfo.editMoveIn" %>
...
<tr class="zhengwen">
    <td align="right" height="25" class="zhengwenjiacu"width="150" bgcolor="#CCFFFF">迁入日期：</td>
    ...
    <input id="CalendarStart" onclick="PopCalendar(txtFileds04);return false;" tabIndex="1" type="image" src="/images/calendar.gif" align="absMiddle"></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">迁出地省市县(区)名称：</td>
  <td align="left"><asp:TextBox ID="txtFileds05" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">迁出地详址：</td>
  <td align="left"><uc1:ucAreaSel　ID="UcAreaSel06" runat="server" />
  </td>
</tr>
<tr class="zhengwen">
...
<tr class="zhengwen">
  ...
  <td align="left"><asp:TextBox ID="txtFileds08" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
<tr class="zhengwen">
  <td align="right" height="25" class="zhengwenjiacu" bgcolor="#CCFFFF">住址居(村)委会名称：</td>
  <td align="left"><asp:TextBox ID="txtFileds09" runat="server" EnableViewState="False" MaxLength="50" Width="200px"/></td>
</tr>
