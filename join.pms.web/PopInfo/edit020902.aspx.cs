...
namespace AreWeb.CertificateInOne.PopInfo
{
    public partial class edit020902 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!ValidIDCard.VerifyIDCard(Fileds03)) strErr += "身份证号码有误！！\\n";
            if (!ValidIDCard.VerifyIDCard(Fileds05)) strErr += "配偶身份证号码有误！！\\n";
            if (String.IsNullOrEmpty(Fileds09)) strErr += "请选择家庭地址！\\n";
            ...
            try
            {
                ...
                if (m_ActionName == "edit")
                {
                    ...
                    {
                        string opContents = "用户ID[" + m_UserID + "]于 " + DateTime.Now.ToString() + " 修改了住建局下的<政策性优先照顾计生户信息>：" + returnVal;
                ...
                DbHelperSQL.ExecuteSql(m_SqlParams);
                Response.Write(" <script>alert('政策性优先照顾计生户信息操作成功！') ;window.location.href='" + m_TargetUrl + "'</script>");
            }
            catch (Exception ex)
            {
