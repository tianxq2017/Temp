<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatsByDetail.aspx.cs" Inherits="join.pms.web.SysAdmin.StatsByDetail" %>
    ...
    <tr>
        ...
        <td width="150" align="left" bgcolor="#F4FAFA">
            <asp:DropDownList ID="ddlBJType" runat="server">  
                ...
                <asp:ListItem Value="0122">再生育审批</asp:ListItem>
            </asp:DropDownList>
        </td>
