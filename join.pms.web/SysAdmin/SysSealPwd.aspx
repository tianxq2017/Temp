<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysSealPwd.aspx.cs" Inherits="join.pms.web.SysAdmin.SysSealPwd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>修改公章、签名密码修改</title>
...
<!--提示信息-->
<div class="tsxx">提示信息：请操新密码和确认密码后，点击“提交”按钮即可完成操作。</div>
<!--Start-->
...
<tr>
  ...
  <td width="*" align="left" class="txt1"><asp:TextBox ID="txtUserPwd" runat="server" EnableViewState="False" MaxLength="16" Width="200px" TextMode="Password"/><span style="color: #ff1400">*</span>(6-16个字符)</td>
</tr>
<tr>
