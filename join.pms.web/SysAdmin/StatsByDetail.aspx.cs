...
{
    public partial class StatsByDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.LiteralNav.Text = "统计分析 > 用户花名册按条件显示 ";
                SetUIParams("", "", "", "");
                GetDataList("", "", "", "", "", "");
            }
        }
        ...
        private void GetDataList(string startDate, string endDate, string startBJDate, string endBJDate, string strBZAttribs, string strBJType)
        {
            ...
            try
            {
                m_SqlParams = "select BizCode,BizName,SelAreaCode,SelAreaName,GetAreaCode,GetAreaName,Fileds01,Fileds02,Fileds03,Fileds04,Fileds13,RegAreaCodeA,RegAreaNameA,Fileds08,Fileds09,Fileds10,Fileds11,Fileds33,RegAreaCodeB,RegAreaNameB,Attribs from BIZ_Contents where 1=1 " + searchStr + "";
                m_Dt = DbHelperSQL.Query(m_SqlParams).Tables[0];
                sHtml.Append("系统应用情况统计如下：<br/>");
                sHtml.Append("<table width=\"1050\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"#666666\"><tr>");
                sHtml.Append("<td width=\"50\" height=\"30\" align=\"center\" bgcolor=\"#cccccc\" ><strong>序号</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp;<strong>业务编号</strong></td>");
                sHtml.Append("<td width=\"100\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>业务名称</strong></td>");
                sHtml.Append("<td width=\"100\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>发起地</strong></td>");
                sHtml.Append("<td width=\"100\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>发证地</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>姓名</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>性别</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>民族</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>户籍性质</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>婚姻状况</strong></td>");
                sHtml.Append("<td width=\"100\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>户籍地</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>姓名</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>性别</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>民族</strong></td>");
                sHtml.Append("<td width=\"50\" class=\"fb01\" bgcolor=\"#cccccc\" >&nbsp<strong>户籍性质</strong></td>");
                ...
                if (m_Dt.Rows.Count > 0)
                {
                    ...
                    sHtml.Append("<table width=\"1050\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"#666666\">");
                    ...
                    for (int k = 0; k < m_Dt.Rows.Count; k++)
                    {
                        ...
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][0].ToString() + "</td>");
                        sHtml.Append("<td width=\"100\" align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][1].ToString() + "</td>");
                        sHtml.Append("<td width=\"100\" align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][3].ToString() + "</td>");
                        sHtml.Append("<td width=\"100\" align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][5].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][6].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][7].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][8].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][9].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\" align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][10].ToString() + "</td>");
                        sHtml.Append("<td width=\"100\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][12].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][13].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][14].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][15].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][16].ToString() + "</td>");
                        sHtml.Append("<td width=\"50\" align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][17].ToString() + "</td>");
                        sHtml.Append("<td width=\"100\"  align=\"left\" bgcolor=\"#FFFFFF\">&nbsp;" + m_Dt.Rows[k][19].ToString() + "</td>");
                        sHtml.Append("</tr>");
                    }
                    sHtml.Append("</table>");
                }
