...
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="small">
    ...
    <td align="left" bgcolor="#F4FAFA"><asp:Button ID="btnAdd" runat="server" Text="· 查询 ·" class="submit6" OnClick="btnAdd_Click"></asp:Button>
    <!--<asp:Button ID="butExport" runat="server" Text="· 导出 ·" class="cusersubmit" OnClick="butExport_Click" ></asp:Button>-->
    <input type="button" name="ButBackPage" value="图形分析" id="ButBackPage" onclick="javascript:window.location.href='<%=m_UrlParams %>';" class="submit6" />
    </td>
    </tr>
</table>
<!--结果展示-->
